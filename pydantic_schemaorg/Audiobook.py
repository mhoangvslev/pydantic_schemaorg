...
class Audiobook(SchemaOrgBase):
    ...
    readBy: Union[List[str], str] = Field(
        default=None,
        description="A person who reads (performs) the audiobook.",union_mode="smart"
    )
    ...
    transcript: Union[List[str], str] = Field(
        default=None,
        description="If this MediaObject is an AudioObject or VideoObject, the transcript of that object.",union_mode="smart"
    )
    
    embeddedTextCaption: Union[List[str], str] = Field(
        default=None,
        description="Represents textual captioning from a [[MediaObject]], e.g. text of a 'meme'.",union_mode="smart"
    )
    
    caption: Union[List[str], str] = Field(
        default=None,
        description="The caption for this object. For downloadable machine formats (closed caption, subtitles"
     "etc.) use MediaObject and indicate the [[encodingFormat]].",union_mode="smart"
    )
    ...
    abridged: Union[List[str], str] = Field(
        default=None,
        description="Indicates whether the book is an abridged edition.",union_mode="smart"
    )
    
    bookEdition: Union[List[str], str] = Field(
        default=None,
        description="The edition of the book.",union_mode="smart"
    )
    
    numberOfPages: Union[List[str], str] = Field(
        default=None,
        description="The number of pages in the book.",union_mode="smart"
    )
    
    bookFormat: Union[List[str], str] = Field(
        default=None,
        description="The format of the book.",union_mode="smart"
    )
    
    illustrator: Union[List[str], str] = Field(
        default=None,
        description="The illustrator of the book.",union_mode="smart"
    )
    
    isbn: Union[List[str], str] = Field(
        default=None,
        description="The ISBN of the book.",union_mode="smart"
    )
    

if TYPE_CHECKING:
    from pydantic_schemaorg import Duration, Person
    from pydantic_schemaorg import Text, MediaObject
    ...
    from pydantic_schemaorg import Text, StrictBool, BookFormatType, Boolean, Integer, int, Person
    from pydantic_schemaorg import Grant, datetime, DateTime, CorrectionComment, Claim, Thing, Offer, Person, Clip, Integer, DefinedTerm, StrictInt, StrictFloat, VideoObject, date, SizeSpecification, Boolean, Country, Text, StrictBool, AggregateRating, AlignmentObject, ImageObject, CreativeWork, WebPage, Number, Language, Organization, Audience, Product, Demand, MusicRecording, Date, URL, AudioObject, Place, Duration, InteractionCounter, Event, Review, QuantitativeValue, int, Comment, Rating, MediaObject, PublicationEvent, AnyUrl, ItemList
    from pydantic_schemaorg import Event, Action, PropertyValue, TextObject, Text, URL, ImageObject, CreativeWork, AnyUrl
