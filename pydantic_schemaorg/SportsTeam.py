...
class SportsTeam(SchemaOrgBase):
    ...
    coach: Union[List[str], str] = Field(
        default=None,
        description="A person that acts in a coaching role for a sports team.",union_mode="smart"
    )
    
    athlete: Union[List[str], str] = Field(
        default=None,
        description="A person that acts as performing member of a sports team; a player as opposed to a coach.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, GenderType, Person
