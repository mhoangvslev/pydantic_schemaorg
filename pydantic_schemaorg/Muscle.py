...
class Muscle(SchemaOrgBase):
    ...
    antagonist: Union[List[str], str] = Field(
        default=None,
        description="The muscle whose action counteracts the specified muscle.",union_mode="smart"
    )
    
    nerve: Union[List[str], str] = Field(
        default=None,
        description="The underlying innervation associated with the muscle.",union_mode="smart"
    )
    
    muscleAction: Union[List[str], str] = Field(
        default=None,
        description="The movement the muscle generates.",union_mode="smart"
    )
    
    bloodSupply: Union[List[str], str] = Field(
        default=None,
        description="The blood vessel that carries blood from the heart to the muscle.",union_mode="smart"
    )
    
    insertion: Union[List[str], str] = Field(
        default=None,
        description="The place of attachment of a muscle, or what the muscle moves.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, AnatomicalStructure, Muscle, Vessel, Nerve
