...
class FollowAction(SchemaOrgBase):
    ...
    followee: Union[List[str], str] = Field(
        default=None,
        description="A sub property of object. The person or organization being followed.",union_mode="smart"
    )
