...
class VoteAction(SchemaOrgBase):
    ...
    candidate: Union[List[str], str] = Field(
        default=None,
        description="A sub property of object. The candidate subject of this action.",union_mode="smart"
    )
    
    option: Union[List[str], str] = Field(
        default=None,
        description="A sub property of object. The options subject to this action.",union_mode="smart"
    )
    
    actionOption: Union[List[str], str] = Field(
        default=None,
        description="A sub property of object. The options subject to this action.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    ...
    from pydantic_schemaorg import Text, Thing
