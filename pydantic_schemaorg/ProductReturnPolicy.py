...
class ProductReturnPolicy(Intangible):
    ...
    productReturnLink: Optional[Union[List[Union[AnyUrl, 'URL', str]], AnyUrl, 'URL', str]] = Field(
        default=None,
        description="Indicates a Web page or service by URL, for product return.",
    )
    productReturnDays: Optional[Union[List[Union[int, 'Integer', str]], int, 'Integer', str]] = Field(
        default=None,
