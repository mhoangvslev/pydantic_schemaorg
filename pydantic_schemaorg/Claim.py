...
class Claim(SchemaOrgBase):
    ...
    appearance: Union[List[str], str] = Field(
        default=None,
        description="Indicates an occurrence of a [[Claim]] in some [[CreativeWork]].",union_mode="smart"
    )
    
    claimInterpreter: Union[List[str], str] = Field(
        default=None,
        description="For a [[Claim]] interpreted from [[MediaObject]] content sed to indicate a claim contained,"
     "implied or refined from the content of a [[MediaObject]].",union_mode="smart"
    )
    
    firstAppearance: Union[List[str], str] = Field(
        default=None,
        description="Indicates the first known occurrence of a [[Claim]] in some [[CreativeWork]].",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Organization, CreativeWork, Person
