...
class MenuSection(SchemaOrgBase):
    ...
    hasMenuSection: Union[List[str], str] = Field(
        default=None,
        description="A subgrouping of the menu (by dishes, course, serving time period, etc.).",union_mode="smart"
    )
    
    hasMenuItem: Union[List[str], str] = Field(
        default=None,
        description="A food or drink item contained in a menu or menu section.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import MenuItem, MenuSection
