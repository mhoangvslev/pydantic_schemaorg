...
class BusTrip(SchemaOrgBase):
    ...
    arrivalBusStop: Union[List[str], str] = Field(
        default=None,
        description="The stop or station from which the bus arrives.",union_mode="smart"
    )
    
    busNumber: Union[List[str], str] = Field(
        default=None,
        description="The unique identifier for the bus.",union_mode="smart"
    )
    
    departureBusStop: Union[List[str], str] = Field(
        default=None,
        description="The stop or station from which the bus departs.",union_mode="smart"
    )
    
    busName: Union[List[str], str] = Field(
        default=None,
        description="The name of the bus (e.g. Bolt Express).",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, BusStation, BusStop
