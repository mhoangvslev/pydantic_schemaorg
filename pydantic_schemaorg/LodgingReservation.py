...
class LodgingReservation(SchemaOrgBase):
    ...
    checkinTime: Union[List[str], str] = Field(
        default=None,
        description="The earliest someone may check into a lodging establishment.",union_mode="smart"
    )
    
    checkoutTime: Union[List[str], str] = Field(
        default=None,
        description="The latest someone may check out of a lodging establishment.",union_mode="smart"
    )
    
    numChildren: Union[List[str], str] = Field(
        default=None,
        description="The number of children staying in the unit.",union_mode="smart"
    )
    
    numAdults: Union[List[str], str] = Field(
        default=None,
        description="The number of adults staying in the unit.",union_mode="smart"
    )
    
    lodgingUnitDescription: Union[List[str], str] = Field(
        default=None,
        description="A full description of the lodging unit.",union_mode="smart"
    )
    
    lodgingUnitType: Union[List[str], str] = Field(
        default=None,
        description="Textual description of the unit type (including suite vs. room, size of bed, etc.).",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import datetime, DateTime, QualitativeValue, QuantitativeValue, int, Time, Text, time, Integer
