...
class CompoundPriceSpecification(SchemaOrgBase):
    ...
    priceComponent: Union[List[str], str] = Field(
        default=None,
        description="This property links to all [[UnitPriceSpecification]] nodes that apply in parallel"
     "for the [[CompoundPriceSpecification]] node.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, UnitPriceSpecification, PriceTypeEnumeration
