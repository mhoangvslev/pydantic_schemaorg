...
class ReviewAction(SchemaOrgBase):
    ...
    resultReview: Union[List[str], str] = Field(
        default=None,
        description="A sub property of result. The review that resulted in the performing of the action.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Review
