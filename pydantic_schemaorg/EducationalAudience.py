...
class EducationalAudience(SchemaOrgBase):
    ...
    educationalRole: Union[List[str], str] = Field(
        default=None,
        description="An educationalRole of an EducationalAudience.",union_mode="smart"
    )
