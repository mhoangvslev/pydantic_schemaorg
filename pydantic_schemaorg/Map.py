...
class Map(SchemaOrgBase):
    ...
    mapType: Union[List[str], str] = Field(
        default=None,
        description="Indicates the kind of Map, from the MapCategoryType Enumeration.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import MapCategoryType
