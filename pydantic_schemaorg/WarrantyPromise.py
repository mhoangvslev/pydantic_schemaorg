...
class WarrantyPromise(SchemaOrgBase):
    ...
    warrantyScope: Union[List[str], str] = Field(
        default=None,
        description="The scope of the warranty promise.",union_mode="smart"
    )
    
    durationOfWarranty: Union[List[str], str] = Field(
        default=None,
        description="The duration of the warranty promise. Common unitCode values are ANN for year, MON for"
     "months, or DAY for days.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import QuantitativeValue, WarrantyScope
