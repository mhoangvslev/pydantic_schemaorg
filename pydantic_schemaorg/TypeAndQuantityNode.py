...
class TypeAndQuantityNode(SchemaOrgBase):
    ...
    amountOfThisGood: Union[List[str], str] = Field(
        default=None,
        description="The quantity of the goods included in the offer.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Product, Service, BusinessFunction, Text, URL, Number, AnyUrl, StrictInt, StrictFloat
