...
class DefinedRegion(SchemaOrgBase):
    ...
    postalCodeRange: Union[List[str], str] = Field(
        default=None,
        description="A defined range of postal codes.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, Country, PostalCodeRangeSpecification
