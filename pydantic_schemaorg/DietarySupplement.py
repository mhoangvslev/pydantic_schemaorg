...
class DietarySupplement(SchemaOrgBase):
    ...
    recommendedIntake: Union[List[str], str] = Field(
        default=None,
    ...
    safetyConsideration: Union[List[str], str] = Field(
        default=None,
     ...
     "documented efficacy of the supplement.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, StrictBool, DrugLegalStatus, Boolean, MedicalEnumeration, MaximumDoseSchedule, RecommendedDoseSchedule
