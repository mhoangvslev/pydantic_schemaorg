...
class ImageObjectSnapshot(SchemaOrgBase):
    ...
    representativeOfPage: Union[List[str], str] = Field(
        default=None,
        description="Indicates whether this image is representative of the content of the page.",union_mode="smart"
    )
    
    exifData: Union[List[str], str] = Field(
        default=None,
        description="exif data for this object.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, StrictBool, MediaObject, Boolean, PropertyValue
