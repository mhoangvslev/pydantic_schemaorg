...
class TVClip(SchemaOrgBase):
    ...
    partOfEpisode: Union[List[str], str] = Field(
        default=None,
        description="The episode to which this clip belongs.",union_mode="smart"
    )
    
    clipNumber: Union[List[str], str] = Field(
        default=None,
        description="Position of the clip within an ordered group of clips.",union_mode="smart"
    )
    
    endOffset: Union[List[str], str] = Field(
        default=None,
        description="The end time of the clip expressed as the number of seconds from the beginning of the work.",union_mode="smart"
    )
    ...
    startOffset: Union[List[str], str] = Field(
        default=None,
...
if TYPE_CHECKING:
    from pydantic_schemaorg import TVSeries
    from pydantic_schemaorg import MusicGroup, StrictInt, StrictFloat, CreativeWorkSeason, HyperTocEntry, Episode, int, CreativeWorkSeries, Person, Text, Integer, Number
