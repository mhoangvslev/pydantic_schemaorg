...
class SpeakableSpecification(SchemaOrgBase):
    ...
    xpath: Union[List[str], str] = Field(
        default=None,
        description="An XPath, e.g. of a [[SpeakableSpecification]] or [[WebPageElement]]. In the latter"
     "case, multiple matches within a page can constitute a single conceptual \"Web page element\".",union_mode="smart"
    )
    
    cssSelector: Union[List[str], str] = Field(
        default=None,
...
if TYPE_CHECKING:
    from pydantic_schemaorg import XPathType, CssSelectorType
