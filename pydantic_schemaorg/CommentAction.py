...
class CommentAction(SchemaOrgBase):
    ...
    resultComment: Union[List[str], str] = Field(
        default=None,
        description="A sub property of result. The Comment created or sent as a result of this action.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Comment
