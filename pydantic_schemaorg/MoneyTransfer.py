...
class MoneyTransfer(SchemaOrgBase):
    ...
    beneficiaryBank: Union[List[str], str] = Field(
        default=None,
        description="A bank or bank’s branch, financial institution or international financial institution"
     "operating the beneficiary’s bank account or releasing funds for the beneficiary.",union_mode="smart"
    )
    
    amount: Union[List[str], str] = Field(
        default=None,
        description="The amount of money.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, BankOrCreditUnion, StrictInt, StrictFloat, MonetaryAmount, Number
