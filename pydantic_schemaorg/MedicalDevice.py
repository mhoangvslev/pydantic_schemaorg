...
class MedicalDevice(SchemaOrgBase):
    ...
    postOp: Union[List[str], str] = Field(
        default=None,
        description="A description of the postoperative procedures, care, and/or followups for this device.",union_mode="smart"
    )
    
    preOp: Union[List[str], str] = Field(
        default=None,
        description="A description of the workup, testing, and other preparations required before implanting"
     "this device.",union_mode="smart"
    )
    
    procedure: Union[List[str], str] = Field(
        default=None,
        description="A description of the procedure involved in setting up, using, and/or installing the"
     "device.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, MedicalContraindication, MedicalEntity
