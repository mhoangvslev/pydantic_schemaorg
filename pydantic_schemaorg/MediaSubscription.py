...
class MediaSubscription(SchemaOrgBase):
    ...
    authenticator: Union[List[str], str] = Field(
        default=None,
     ...
     "before playing media.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Offer, Organization
