...
class RsvpAction(SchemaOrgBase):
    ...
    additionalNumberOfGuests: Union[List[str], str] = Field(
        default=None,
        description="If responding yes, the number of guests who will attend in addition to the invitee.",union_mode="smart"
    )
    
    rsvpResponse: Union[List[str], str] = Field(
        default=None,
        description="The response (yes, no, maybe) to the RSVP.",union_mode="smart"
    )
    ...
    language: Union[List[str], str] = Field(
        default=None,
        description="A sub property of instrument. The language used on this action.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import RsvpResponseType, Number, Comment, StrictInt, StrictFloat
    from pydantic_schemaorg import Event
    from pydantic_schemaorg import Text, Language, Audience, Organization, Thing, ContactPoint, Person
