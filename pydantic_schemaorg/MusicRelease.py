...
class MusicRelease(SchemaOrgBase):
    ...
    releaseOf: Union[List[str], str] = Field(
        default=None,
        description="The album this is a release of.",union_mode="smart"
    )
    
    creditedTo: Union[List[str], str] = Field(
        default=None,
        description="The group the release is credited to if different than the byArtist. For example, Red"
     "and Blue is credited to \"Stefani Germanotta Band\", but by Lady Gaga.",union_mode="smart"
    )
    
    recordLabel: Union[List[str], str] = Field(
        default=None,
        description="The label that issued the release.",union_mode="smart"
    )
    
    catalogNumber: Union[List[str], str] = Field(
        default=None,
        description="The catalog number for the release.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, Organization, MusicReleaseFormatType, MusicAlbum, Duration, Person
