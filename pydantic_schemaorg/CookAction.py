...
class CookAction(SchemaOrgBase):
    ...
    recipe: Union[List[str], str] = Field(
        default=None,
        description="A sub property of instrument. The recipe/instructions used to perform the action.",union_mode="smart"
    )
    
    foodEstablishment: Union[List[str], str] = Field(
        default=None,
        description="A sub property of location. The specific food establishment where the action occurred.",union_mode="smart"
    )
    
    foodEvent: Union[List[str], str] = Field(
        default=None,
        description="A sub property of location. The specific food event where the action occurred.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import FoodEvent, Recipe, FoodEstablishment, Place
