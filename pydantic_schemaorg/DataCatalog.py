...
class DataCatalog(SchemaOrgBase):
    ...
    dataset: Union[List[str], str] = Field(
        default=None,
        description="A dataset contained in this catalog.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, URL, DefinedTerm, MeasurementMethodEnum, AnyUrl, Dataset
