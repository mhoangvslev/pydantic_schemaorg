...
class MathSolver(SchemaOrgBase):
    ...
    mathExpression: Union[List[str], str] = Field(
        default=None,
     ...
     "math as you would write with a keyboard.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, SolveMathAction
