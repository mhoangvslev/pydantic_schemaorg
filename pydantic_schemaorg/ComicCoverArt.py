...
class ComicCoverArt(SchemaOrgBase):
    ...
    letterer: Union[List[str], str] = Field(
        default=None,
        description="The individual who adds lettering, including speech balloons and sound effects, to"
     "artwork.",union_mode="smart"
    )
    
    colorist: Union[List[str], str] = Field(
        default=None,
        description="The individual who adds color to inked drawings.",union_mode="smart"
    )
    
    artEdition: Union[List[str], str] = Field(
        default=None,
     ...
     "this example \"20\").",union_mode="smart"
    )
    
    artist: Union[List[str], str] = Field(
        default=None,
        description="The primary artist for a work in a medium other than pencils or digital line art--for example,"
     "if the primary artwork is done in watercolors or digital paints.",union_mode="smart"
    )
    ...
    artform: Union[List[str], str] = Field(
        default=None,
        description="e.g. Painting, Drawing, Sculpture, Print, Photograph, Assemblage, Collage, etc.",union_mode="smart"
    )
    ...
    penciler: Union[List[str], str] = Field(
        default=None,
        description="The individual who draws the primary narrative artwork.",union_mode="smart"
    )
    
    surface: Union[List[str], str] = Field(
        default=None,
        description="A material used as a surface in some artwork, e.g. Canvas, Paper, Wood, Board, etc.",union_mode="smart"
    )
    
    inker: Union[List[str], str] = Field(
        default=None,
        description="The individual who traces over the pencil drawings in ink after pencils are complete.",union_mode="smart"
    )
    
    artMedium: Union[List[str], str] = Field(
        default=None,
        description="The material used. (E.g. Oil, Watercolour, Acrylic, Linoprint, Marble, Cyanotype,"
     "Digital, Lithograph, DryPoint, Intaglio, Pastel, Woodcut, Pencil, Mixed Media, etc.)",union_mode="smart"
    )
    ...
    artworkSurface: Union[List[str], str] = Field(
        default=None,
        description="The supporting materials for the artwork, e.g. Canvas, Paper, Wood, Board, etc.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Distance, QuantitativeValue, int, Person, Text, URL, Integer, AnyUrl
    ...
    from pydantic_schemaorg import Person
    from pydantic_schemaorg import Grant, datetime, DateTime, CorrectionComment, Claim, Thing, Offer, Person, Clip, Integer, DefinedTerm, StrictInt, StrictFloat, VideoObject, date, SizeSpecification, Boolean, Country, Text, StrictBool, AggregateRating, AlignmentObject, ImageObject, CreativeWork, WebPage, Number, Language, Organization, Audience, Product, Demand, MusicRecording, Date, URL, AudioObject, Place, Duration, InteractionCounter, Event, Review, QuantitativeValue, int, Comment, Rating, MediaObject, PublicationEvent, AnyUrl, ItemList
    from pydantic_schemaorg import Event, Action, PropertyValue, TextObject, Text, URL, ImageObject, CreativeWork, AnyUrl
