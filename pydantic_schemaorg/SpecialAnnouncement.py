...
class SpecialAnnouncement(SchemaOrgBase):
    ...
    publicTransportClosuresInfo: Union[List[str], str] = Field(
        default=None,
        description="Information about public transport closures.",union_mode="smart"
    )
    
    announcementLocation: Union[List[str], str] = Field(
        default=None,
     ...
     "use [[spatialCoverage]].",union_mode="smart"
    )
    
    schoolClosuresInfo: Union[List[str], str] = Field(
        default=None,
        description="Information about school closures.",union_mode="smart"
    )
    ...
    quarantineGuidelines: Union[List[str], str] = Field(
        default=None,
        description="Guidelines about quarantine rules, e.g. in the context of a pandemic.",union_mode="smart"
    )
    
    newsUpdatesAndGuidelines: Union[List[str], str] = Field(
        default=None,
        description="Indicates a page with news updates and guidelines. This could often be (but is not required"
     "to be) the main page containing [[SpecialAnnouncement]] markup on a site.",union_mode="smart"
    )
    
    diseasePreventionInfo: Union[List[str], str] = Field(
        default=None,
        description="Information about disease prevention.",union_mode="smart"
    )
    
    governmentBenefitsInfo: Union[List[str], str] = Field(
        default=None,
        description="governmentBenefitsInfo provides information about government benefits associated"
     "with a SpecialAnnouncement.",union_mode="smart"
    )
    
    webFeed: Union[List[str], str] = Field(
        default=None,
        description="The URL for a feed, e.g. associated with a podcast series, blog, or series of date-stamped"
     "updates. This is usually RSS or Atom.",union_mode="smart"
    )
    
    travelBans: Union[List[str], str] = Field(
        default=None,
        description="Information about travel bans, e.g. in the context of a pandemic.",union_mode="smart"
    )
    ...
    gettingTestedInfo: Union[List[str], str] = Field(
        default=None,
        description="Information about getting tested (for a [[MedicalCondition]]), e.g. in the context"
     "of a pandemic.",union_mode="smart"
    )
    
    diseaseSpreadStatistics: Union[List[str], str] = Field(
        default=None,
...
if TYPE_CHECKING:
    from pydantic_schemaorg import date, datetime, DateTime, PhysicalActivityCategory, Thing, GovernmentService, Date, WebContent, Text, DataFeed, URL, LocalBusiness, CategoryCode, Observation, CivicStructure, Dataset, AnyUrl
