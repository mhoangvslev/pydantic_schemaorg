...
class Suite(SchemaOrgBase):
    ...
    bed: Union[List[str], str] = Field(
     ...
     "use the amenityFeature property.",union_mode="smart"
    )
    
    occupancy: Union[List[str], str] = Field(
        default=None,
     ...
     "person). Typical unit code(s): C62 for person.",union_mode="smart"
    )
    ...
    yearBuilt: Union[List[str], str] = Field(
        default=None,
        description="The year an [[Accommodation]] was constructed. This corresponds to the [YearBuilt"
     "field in RESO](https://ddwiki.reso.org/display/DDW17/YearBuilt+Field).",union_mode="smart"
    )
    ...
    accommodationCategory: Union[List[str], str] = Field(
        default=None,
     ...
     "fields for suggested values).",union_mode="smart"
    )
    
    permittedUsage: Union[List[str], str] = Field(
        default=None,
        description="Indications regarding the permitted usage of the accommodation.",union_mode="smart"
    )
    ...
    floorLevel: Union[List[str], str] = Field(
        default=None,
     ...
     "the local system should be used where possible.",union_mode="smart"
    )
    ...
    accommodationFloorPlan: Union[List[str], str] = Field(
        default=None,
        description="A floorplan of some [[Accommodation]].",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, StrictInt, StrictFloat, BedDetails, QuantitativeValue, Number, BedType
    from pydantic_schemaorg import StrictInt, StrictFloat, BedType, BedDetails, Boolean, LocationFeatureSpecification, AnyUrl, QuantitativeValue, int, FloorPlan, Text, StrictBool, URL, Integer, Duration, Number
