...
class MusicRecording(SchemaOrgBase):
    ...
    recordingOf: Union[List[str], str] = Field(
        default=None,
        description="The composition this track is a recording of.",union_mode="smart"
    )
    
    inPlaylist: Union[List[str], str] = Field(
        default=None,
        description="The playlist to which this recording belongs.",union_mode="smart"
    )
    
    inAlbum: Union[List[str], str] = Field(
        default=None,
        description="The album to which this recording belongs.",union_mode="smart"
    )
    ...
    isrcCode: Union[List[str], str] = Field(
        default=None,
        description="The International Standard Recording Code for the recording.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, MusicGroup, MusicPlaylist, MusicAlbum, Duration, Person, MusicComposition
