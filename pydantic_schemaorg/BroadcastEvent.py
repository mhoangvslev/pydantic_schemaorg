...
class BroadcastEvent(SchemaOrgBase):
    ...
    videoFormat: Union[List[str], str] = Field(
        default=None,
        description="The type of screening or video broadcast used (e.g. IMAX, 3D, SD, HD, etc.).",union_mode="smart"
    )
    
    broadcastOfEvent: Union[List[str], str] = Field(
        default=None,
        description="The event being broadcast such as a sporting event or awards ceremony.",union_mode="smart"
    )
    
    isLiveBroadcast: Union[List[str], str] = Field(
        default=None,
        description="True if the broadcast is of a live event.",union_mode="smart"
    )
    ...
    publishedOn: Union[List[str], str] = Field(
        default=None,
        description="A broadcast service associated with the publication event.",union_mode="smart"
    )
    
    free: Union[List[str], str] = Field(
        default=None,
        description="A flag to signal that the item, event, or place is accessible for free.",union_mode="smart"
    )
    
    publishedBy: Union[List[str], str] = Field(
        default=None,
        description="An agent associated with the publication event.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, StrictBool, Language, Event, Boolean
    from pydantic_schemaorg import StrictBool, Organization, Boolean, BroadcastService, Person
