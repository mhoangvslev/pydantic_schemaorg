...
class FastFoodRestaurant(SchemaOrgBase):
    ...
    servesCuisine: Union[List[str], str] = Field(
        default=None,
        description="The cuisine of the restaurant.",union_mode="smart"
    )
    
    menu: Union[List[str], str] = Field(
        default=None,
        description="Either the actual menu as a structured representation, as text, or a URL of the menu.",union_mode="smart"
    )
    
    acceptsReservations: Union[List[str], str] = Field(
        default=None,
     ...
     "```Yes``` or ```No```.",union_mode="smart"
    )
    
    hasMenu: Union[List[str], str] = Field(
        default=None,
        description="Either the actual menu as a structured representation, as text, or a URL of the menu.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, Menu, StrictBool, URL, Boolean, AnyUrl, Rating
