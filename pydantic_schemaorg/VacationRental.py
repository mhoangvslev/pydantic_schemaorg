...
class VacationRental(SchemaOrgBase):
    ...
    starRating: Union[List[str], str] = Field(
        default=None,
     ...
     "e.g. as an Organization with name such as (e.g. HOTREC, DEHOGA, WHR, or Hotelstars).",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Language, Audience, StrictInt, StrictFloat, datetime, LocationFeatureSpecification, DateTime, Boolean, QuantitativeValue, Time, Rating, Text, StrictBool, time, Number
