...
class ExchangeRateSpecification(SchemaOrgBase):
    ...
    exchangeRateSpread: Union[List[str], str] = Field(
        default=None,
        description="The difference between the price at which a broker or other intermediary buys and sells"
     "foreign currency.",union_mode="smart"
    )
    
    currentExchangeRate: Union[List[str], str] = Field(
        default=None,
        description="The current price of a currency.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, MonetaryAmount, UnitPriceSpecification, Number, StrictInt, StrictFloat
