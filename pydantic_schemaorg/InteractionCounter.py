...
class InteractionCounter(SchemaOrgBase):
    ...
    userInteractionCount: Union[List[str], str] = Field(
        default=None,
        description="The number of interactions for the CreativeWork using the WebSite or SoftwareApplication.",union_mode="smart"
    )
    
    interactionService: Union[List[str], str] = Field(
        default=None,
        description="The WebSite or SoftwareApplication where the interactions took place.",union_mode="smart"
    )
    ...
    interactionType: Union[List[str], str] = Field(
        default=None,
        description="The Action representing the type of interaction. For up votes, +1s, etc. use [[LikeAction]]."
     "For down votes use [[DislikeAction]]. Otherwise, use the most specific Action.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import SoftwareApplication, WebSite, datetime, Place, DateTime, Action, int, Time, Text, VirtualLocation, time, Integer, PostalAddress
