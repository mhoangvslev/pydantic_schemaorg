...
class DiagnosticLab(SchemaOrgBase):
    """A medical laboratory that offers on-site or off-site diagnostic services.

    See: https://schema.org/DiagnosticLab
    Model depth: 4
    """
    type_: str = Field(default="DiagnosticLab", alias='@type')
    
    availableTest: Union[List[str], str] = Field(
        default=None,
        description="A diagnostic test or procedure offered by this lab.",union_mode="smart"
    )
