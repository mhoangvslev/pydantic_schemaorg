...
class Gene(SchemaOrgBase):
    ...
    encodesBioChemEntity: Union[List[str], str] = Field(
        default=None,
        description="Another BioChemEntity encoded by this one.",union_mode="smart"
    )
    
    alternativeOf: Union[List[str], str] = Field(
        default=None,
        description="Another gene which is a variation of this one.",union_mode="smart"
    )
    
    hasBioPolymerSequence: Union[List[str], str] = Field(
        default=None,
        description="A symbolic representation of a BioChemEntity. For example, a nucleotide sequence of"
     "a Gene or an amino acid sequence of a Protein.",union_mode="smart"
    )
    
    expressedIn: Union[List[str], str] = Field(
        default=None,
        description="Tissue, organ, biological sample, etc in which activity of this gene has been observed"
     "experimentally. For example brain, digestive system.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, Gene, AnatomicalSystem, AnatomicalStructure, BioChemEntity, DefinedTerm
