...
class Recipe(SchemaOrgBase):
    ...
    cookTime: Union[List[str], str] = Field(
        default=None,
        description="The time it takes to actually cook the dish, in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).",union_mode="smart"
    )
    
    recipeInstructions: Union[List[str], str] = Field(
        default=None,
        description="A step in making the recipe, in the form of a single item (document, video, etc.) or an ordered"
     "list with HowToStep and/or HowToSection items.",union_mode="smart"
    )
    
    recipeIngredient: Union[List[str], str] = Field(
        default=None,
        description="A single ingredient used in the recipe, e.g. sugar, flour or garlic.",union_mode="smart"
    )
    
    recipeCategory: Union[List[str], str] = Field(
        default=None,
        description="The category of the recipe—for example, appetizer, entree, etc.",union_mode="smart"
    )
    ...
    recipeYield: Union[List[str], str] = Field(
        default=None,
        description="The quantity produced by the recipe (for example, number of people served, number of"
     "servings, etc).",union_mode="smart"
    )
    
    recipeCuisine: Union[List[str], str] = Field(
        default=None,
        description="The cuisine of the recipe (for example, French or Ethiopian).",union_mode="smart"
    )
    
    cookingMethod: Union[List[str], str] = Field(
        default=None,
        description="The method of cooking, such as Frying, Steaming, ...",union_mode="smart"
    )
    ...
    supply: Union[List[str], str] = Field(
        default=None,
        description="A sub-property of instrument. A supply consumed when performing instructions or a direction.",union_mode="smart"
    )
    ...
    steps: Union[List[str], str] = Field(
     ...
     "misnamed 'steps'; 'step' is preferred).",union_mode="smart"
    )
    
    totalTime: Union[List[str], str] = Field(
        default=None,
        description="The total time required to perform instructions or a direction (including time to prepare"
     "the supplies), in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).",union_mode="smart"
    )
    
    tool: Union[List[str], str] = Field(
        default=None,
        description="A sub property of instrument. An object used (but not consumed) when performing instructions"
     "or a direction.",union_mode="smart"
    )
    
    yield_: Union[List[str], str] = Field(
        default=None,alias="yield",
        description="The quantity that results by performing instructions. For example, a paper airplane,"
     "10 personalized candles.",union_mode="smart"
    )
    
    performTime: Union[List[str], str] = Field(
        default=None,
        description="The length of time it takes to perform instructions or a direction (not including time"
     "to prepare the supplies), in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).",union_mode="smart"
    )
    
    step: Union[List[str], str] = Field(
        default=None,
        description="A single step item (as HowToStep, text, document, video, etc.) or a HowToSection.",union_mode="smart"
    )
    
    estimatedCost: Union[List[str], str] = Field(
        default=None,
        description="The estimated cost of the supply or supplies consumed when performing instructions.",union_mode="smart"
    )
    
    prepTime: Union[List[str], str] = Field(
        default=None,
        description="The length of time it takes to prepare the items to be used in instructions or a direction,"
     "in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, NutritionInformation, RestrictedDiet, QuantitativeValue, CreativeWork, Duration, ItemList
    from pydantic_schemaorg import MonetaryAmount, HowToTool, HowToSupply, QuantitativeValue, Text, HowToSection, HowToStep, CreativeWork, Duration, ItemList
