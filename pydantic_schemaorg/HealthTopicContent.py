...
class HealthTopicContent(SchemaOrgBase):
    ...
    hasHealthAspect: Union[List[str], str] = Field(
        default=None,
     ...
     "treatments or their side-effects.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import HealthAspectEnumeration
