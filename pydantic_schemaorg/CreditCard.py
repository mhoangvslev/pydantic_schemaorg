...
class CreditCard(SchemaOrgBase):
    ...
    floorLimit: Union[List[str], str] = Field(
        default=None,
        description="A floor limit is the amount of money above which credit card transactions must be authorized.",union_mode="smart"
    )
    
    monthlyMinimumRepaymentAmount: Union[List[str], str] = Field(
        default=None,
        description="The minimum payment is the lowest amount of money that one is required to pay on a credit"
     "card statement each month.",union_mode="smart"
    )
    
    cashBack: Union[List[str], str] = Field(
        default=None,
        description="A cardholder benefit that pays the cardholder a small percentage of their net expenditures.",union_mode="smart"
    )
    
    contactlessPayment: Union[List[str], str] = Field(
        default=None,
        description="A secure method for consumers to purchase products or services via debit, credit or smartcards"
     "by using RFID or NFC technology.",union_mode="smart"
    )
    ...
    renegotiableLoan: Union[List[str], str] = Field(
        default=None,
        description="Whether the terms for payment of interest can be renegotiated during the life of the loan.",union_mode="smart"
    )
    
    loanType: Union[List[str], str] = Field(
        default=None,
        description="The type of a loan or credit.",union_mode="smart"
    )
    
    gracePeriod: Union[List[str], str] = Field(
        default=None,
        description="The period of time after any due date that the borrower has to fulfil its obligations before"
     "a default (failure to pay) is deemed to have occurred.",union_mode="smart"
    )
    ...
    loanRepaymentForm: Union[List[str], str] = Field(
        default=None,
     ...
     "each payment.",union_mode="smart"
    )
    
    loanTerm: Union[List[str], str] = Field(
        default=None,
        description="The duration of the loan or credit agreement.",union_mode="smart"
    )
    
    recourseLoan: Union[List[str], str] = Field(
        default=None,
        description="The only way you get the money back in the event of default is the security. Recourse is"
     "where you still have the opportunity to go back to the borrower for the rest of the money.",union_mode="smart"
    )
    ...
    requiredCollateral: Union[List[str], str] = Field(
        default=None,
        description="Assets required to secure loan or credit repayments. It may take form of third party pledge,"
     "goods, financial instruments (cash, securities, etc.)",union_mode="smart"
    )
    

if TYPE_CHECKING:
    from pydantic_schemaorg import StrictBool, MonetaryAmount, Boolean, Number, StrictInt, StrictFloat
    ...
    from pydantic_schemaorg import Event, Action, PropertyValue, TextObject, Text, URL, ImageObject, CreativeWork, AnyUrl
    from pydantic_schemaorg import RepaymentSpecification, StrictInt, StrictFloat, MonetaryAmount, Boolean, AnyUrl, QuantitativeValue, Thing, Text, StrictBool, URL, Duration, Number
    from pydantic_schemaorg import Text, URL, AnyUrl, QuantitativeValue, Number, StrictInt, StrictFloat
    from pydantic_schemaorg import Audience, Organization, Product, GeoShape, Demand, Offer, Thing, PhysicalActivityCategory, Person, Service, URL, CategoryCode, OpeningHoursSpecification, Brand, Place, ServiceChannel, AdministrativeArea, GovernmentBenefitsType, Review, Text, OfferCatalog, AggregateRating, ImageObject, AnyUrl
    from pydantic_schemaorg import Event, Action, PropertyValue, TextObject, Text, URL, ImageObject, CreativeWork, AnyUrl
