...
class LymphaticVessel(SchemaOrgBase):
    ...
    runsTo: Union[List[str], str] = Field(
        default=None,
        description="The vasculature the lymphatic structure runs, or efferents, to.",union_mode="smart"
    )
    
    regionDrained: Union[List[str], str] = Field(
        default=None,
        description="The anatomical or organ system drained by this vessel; generally refers to a specific"
     "part of an organ.",union_mode="smart"
    )
    
    originatesFrom: Union[List[str], str] = Field(
        default=None,
        description="The vasculature the lymphatic structure originates, or afferents, from.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Vessel, AnatomicalSystem, AnatomicalStructure
