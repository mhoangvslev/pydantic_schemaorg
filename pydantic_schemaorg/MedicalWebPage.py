...
class MedicalWebPage(SchemaOrgBase):
    ...
    aspect: Union[List[str], str] = Field(
        default=None,
        description="An aspect of medical practice that is considered on the page, such as 'diagnosis', 'treatment',"
     "'causes', 'prognosis', 'etiology', 'epidemiology', etc.",union_mode="smart"
    )
    
    medicalAudience: Union[List[str], str] = Field(
        default=None,
        description="Medical audience for page.",union_mode="smart"
    )
    
    reviewedBy: Union[List[str], str] = Field(
        default=None,
        description="People or organizations that have reviewed the content on this web page for accuracy"
     "and/or completeness.",union_mode="smart"
    )
    ...
    primaryImageOfPage: Union[List[str], str] = Field(
        default=None,
        description="Indicates the main image on the page.",union_mode="smart"
    )
    
    relatedLink: Union[List[str], str] = Field(
        default=None,
        description="A link related to this web page, for example to other related web pages.",union_mode="smart"
    )
    
    mainContentOfPage: Union[List[str], str] = Field(
        default=None,
        description="Indicates if this web page element is the main subject of the page.",union_mode="smart"
    )
    
    specialty: Union[List[str], str] = Field(
        default=None,
        description="One of the domain specialities to which this web page's content applies.",union_mode="smart"
    )
    
    significantLink: Union[List[str], str] = Field(
        default=None,
        description="One of the more significant URLs on the page. Typically, these are the non-navigation"
     "links that are clicked on the most.",union_mode="smart"
    )
    
    significantLinks: Union[List[str], str] = Field(
        default=None,
        description="The most significant URLs on the page. Typically, these are the non-navigation links"
     "that are clicked on the most.",union_mode="smart"
    )
    
    breadcrumb: Union[List[str], str] = Field(
        default=None,
        description="A set of links that can help a user understand and navigate a website hierarchy.",union_mode="smart"
    )
    
    lastReviewed: Union[List[str], str] = Field(
        default=None,
        description="Date on which the content on this web page was last reviewed for accuracy and/or completeness.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, MedicalAudience, MedicalAudienceType
    from pydantic_schemaorg import date, Organization, BreadcrumbList, Date, Person, Text, URL, Specialty, WebPageElement, ImageObject, SpeakableSpecification, AnyUrl
