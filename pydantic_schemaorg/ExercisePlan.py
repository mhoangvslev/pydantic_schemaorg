...
class ExercisePlan(SchemaOrgBase):
    ...
    activityDuration: Union[List[str], str] = Field(
        default=None,
        description="Length of time to engage in the activity.",union_mode="smart"
    )
    
    additionalVariable: Union[List[str], str] = Field(
        default=None,
     ...
     "movement, quantitative distance, progressions over time, etc.",union_mode="smart"
    )
    
    intensity: Union[List[str], str] = Field(
        default=None,
        description="Quantitative measure gauging the degree of force involved in the exercise, for example,"
     "heartbeats per minute. May include the velocity of the movement.",union_mode="smart"
    )
    
    restPeriods: Union[List[str], str] = Field(
        default=None,
        description="How often one should break from the activity.",union_mode="smart"
    )
    
    repetitions: Union[List[str], str] = Field(
        default=None,
        description="Number of times one should repeat the activity.",union_mode="smart"
    )
    
    activityFrequency: Union[List[str], str] = Field(
        default=None,
        description="How often one should engage in the activity.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, StrictInt, StrictFloat, QuantitativeValue, Duration, Energy, Number
    from pydantic_schemaorg import AnatomicalSystem, AnatomicalStructure, Thing, PhysicalActivityCategory, Text, URL, SuperficialAnatomy, CategoryCode, AnyUrl
