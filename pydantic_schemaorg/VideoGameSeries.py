...
class VideoGameSeries(SchemaOrgBase):
    """A video game series.
    ...
    numberOfEpisodes: Union[List[str], str] = Field(
        default=None,
        description="The number of episodes in this season or series.",union_mode="smart"
    )
    ...
    episodes: Union[List[str], str] = Field(
        default=None,
        description="An episode of a TV/radio series or season.",union_mode="smart"
    )
    ...
    season: Union[List[str], str] = Field(
        default=None,
        description="A season in a media series.",union_mode="smart"
    )
    ...
    episode: Union[List[str], str] = Field(
        default=None,
        description="An episode of a TV, radio or game media within a series or season.",union_mode="smart"
    )
    ...
    numberOfSeasons: Union[List[str], str] = Field(
        default=None,
        description="The number of seasons in this series.",union_mode="smart"
    )
    
    containsSeason: Union[List[str], str] = Field(
        default=None,
        description="A season that is part of the media series.",union_mode="smart"
    )
    ...
    seasons: Union[List[str], str] = Field(
        default=None,
        description="A season in a media series.",union_mode="smart"
    )
    
    issn: Union[List[str], str] = Field(
        default=None,
     ...
     "for, this serial publication.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import MusicGroup, Organization, Place, CreativeWorkSeason, Episode, QuantitativeValue, Thing, int, Person, Text, URL, PostalAddress, GamePlayMode, Integer, CreativeWork, AnyUrl, VideoObject
    from pydantic_schemaorg import Text, date, datetime, DateTime, Date
