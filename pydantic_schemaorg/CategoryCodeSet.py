...
class CategoryCodeSet(SchemaOrgBase):
    ...
    hasCategoryCode: Union[List[str], str] = Field(
        default=None,
        description="A Category code contained in this code set.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import CategoryCode
    from pydantic_schemaorg import DefinedTerm
