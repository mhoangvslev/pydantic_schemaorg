...
class PaymentChargeSpecification(SchemaOrgBase):
    ...
    appliesToPaymentMethod: Union[List[str], str] = Field(
        default=None,
        description="The payment method(s) to which the payment charge specification applies.",union_mode="smart"
    )
    
    appliesToDeliveryMethod: Union[List[str], str] = Field(
        default=None,
        description="The delivery method(s) to which the delivery charge or payment charge specification"
     "applies.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import DeliveryMethod, PaymentMethod
