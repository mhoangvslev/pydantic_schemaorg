...
class VideoGame(SchemaOrgBase):
    ...
    musicBy: Union[List[str], str] = Field(
        default=None,
        description="The composer of the soundtrack.",union_mode="smart"
    )
    ...
    gamePlatform: Union[List[str], str] = Field(
        default=None,
        description="The electronic systems used to play <a href=\"http://en.wikipedia.org/wiki/Category:Video_game_platforms\">video"
     "games</a>.",union_mode="smart"
    )
    
    trailer: Union[List[str], str] = Field(
        default=None,
        description="The trailer of a movie or TV/radio series, season, episode, etc.",union_mode="smart"
    )
    
    gameTip: Union[List[str], str] = Field(
        default=None,
        description="Links to tips, tactics, etc.",union_mode="smart"
    )
    
    gameServer: Union[List[str], str] = Field(
        default=None,
        description="The server on which it is possible to play the game.",union_mode="smart"
    )
    ...
    directors: Union[List[str], str] = Field(
        default=None,
        description="A director of e.g. TV, radio, movie, video games etc. content. Directors can be associated"
     "with individual items or with a series, episode, clip.",union_mode="smart"
    )
    
    gameEdition: Union[List[str], str] = Field(
        default=None,
        description="The edition of a video game.",union_mode="smart"
    )
    
    playMode: Union[List[str], str] = Field(
        default=None,
        description="Indicates whether this game is multi-player, co-op or single-player. The game can be"
     "marked as multi-player, co-op and single-player at the same time.",union_mode="smart"
    )
    
    cheatCode: Union[List[str], str] = Field(
        default=None,
        description="Cheat codes to the game.",union_mode="smart"
    )
    
    actors: Union[List[str], str] = Field(
        default=None,
        description="An actor, e.g. in TV, radio, movie, video games etc. Actors can be associated with individual"
     "items or with a series, episode, clip.",union_mode="smart"
    )
    
    applicationSubCategory: Union[List[str], str] = Field(
        default=None,
        description="Subcategory of the application, e.g. 'Arcade Game'.",union_mode="smart"
    )
    
    storageRequirements: Union[List[str], str] = Field(
        default=None,
        description="Storage requirements (free space required).",union_mode="smart"
    )
    
    applicationSuite: Union[List[str], str] = Field(
        default=None,
        description="The name of the application suite to which the application belongs (e.g. Excel belongs"
     "to Office).",union_mode="smart"
    )
    
    device: Union[List[str], str] = Field(
        default=None,
        description="Device required to run the application. Used in cases where a specific make/model is"
     "required to run the application.",union_mode="smart"
    )
    
    screenshot: Union[List[str], str] = Field(
        default=None,
        description="A link to a screenshot image of the app.",union_mode="smart"
    )
    
    featureList: Union[List[str], str] = Field(
        default=None,
        description="Features or modules provided by this application (and possibly required by other applications).",union_mode="smart"
    )
    
    installUrl: Union[List[str], str] = Field(
        default=None,
        description="URL at which the app may be installed, if different from the URL of the item.",union_mode="smart"
    )
    
    downloadUrl: Union[List[str], str] = Field(
        default=None,
        description="If the file can be downloaded, URL to download the binary.",union_mode="smart"
    )
    
    supportingData: Union[List[str], str] = Field(
        default=None,
        description="Supporting data for a SoftwareApplication.",union_mode="smart"
    )
    
    fileSize: Union[List[str], str] = Field(
        default=None,
        description="Size of the application / package (e.g. 18MB). In the absence of a unit (MB, KB etc.), KB"
     "will be assumed.",union_mode="smart"
    )
    
    applicationCategory: Union[List[str], str] = Field(
        default=None,
        description="Type of software application, e.g. 'Game, Multimedia'.",union_mode="smart"
    )
    
    countriesNotSupported: Union[List[str], str] = Field(
        default=None,
    ...
    softwareRequirements: Union[List[str], str] = Field(
        default=None,
     ...
     "but required to run the application (examples: DirectX, Java or .NET runtime).",union_mode="smart"
    )
    
    availableOnDevice: Union[List[str], str] = Field(
        default=None,
        description="Device required to run the application. Used in cases where a specific make/model is"
     "required to run the application.",union_mode="smart"
    )
    
    softwareAddOn: Union[List[str], str] = Field(
        default=None,
        description="Additional content for a software application.",union_mode="smart"
    )
    
    softwareHelp: Union[List[str], str] = Field(
        default=None,
        description="Software application help.",union_mode="smart"
    )
    
    operatingSystem: Union[List[str], str] = Field(
        default=None,
        description="Operating systems supported (Windows 7, OS X 10.6, Android 1.6).",union_mode="smart"
    )
    ...
    memoryRequirements: Union[List[str], str] = Field(
        default=None,
        description="Minimum memory requirements.",union_mode="smart"
    )
    
    releaseNotes: Union[List[str], str] = Field(
        default=None,
        description="Description of what changed in this version.",union_mode="smart"
    )
    
    softwareVersion: Union[List[str], str] = Field(
        default=None,
        description="Version of the software instance.",union_mode="smart"
    )
    
    permissions: Union[List[str], str] = Field(
        default=None,
        description="Permission(s) required to run the app (for example, a mobile app may require full internet"
     "access or may run only on wifi).",union_mode="smart"
    )
    
    countriesSupported: Union[List[str], str] = Field(
        default=None,
        description="Countries for which the application is supported. You can also provide the two-letter"
     "ISO 3166-1 alpha-2 country code.",union_mode="smart"
    )
    
    processorRequirements: Union[List[str], str] = Field(
        default=None,
        description="Processor architecture required to run the application (e.g. IA64).",union_mode="smart"
    )
    ...
    numberOfPlayers: Union[List[str], str] = Field(
        default=None,
        description="Indicate how many people can play this game (minimum, maximum, or range).",union_mode="smart"
    )
    
    quest: Union[List[str], str] = Field(
        default=None,
        description="The task that a player-controlled character, or group of characters may complete in"
     "order to gain a reward.",union_mode="smart"
    )
    
    gameItem: Union[List[str], str] = Field(
        default=None,
        description="An item is an object within the game world that can be collected by a player or, occasionally,"
     "a non-player character.",union_mode="smart"
    )
    
    characterAttribute: Union[List[str], str] = Field(
        default=None,
        description="A piece of data that represents a particular aspect of a fictional character (skill,"
     "power, character points, advantage, disadvantage).",union_mode="smart"
    )
    
    gameLocation: Union[List[str], str] = Field(
        default=None,
        description="Real or fictional location of the game (or part of game).",union_mode="smart"
    )
    

if TYPE_CHECKING:
    from pydantic_schemaorg import MusicGroup, Thing, GameServer, Person, Text, URL, GamePlayMode, CreativeWork, AnyUrl, VideoObject
    from pydantic_schemaorg import Text, SoftwareApplication, URL, DataFeed, ImageObject, CreativeWork, AnyUrl
    ...
    from pydantic_schemaorg import URL, Place, QuantitativeValue, Thing, AnyUrl, PostalAddress
    from pydantic_schemaorg import Grant, datetime, DateTime, CorrectionComment, Claim, Thing, Offer, Person, Clip, Integer, DefinedTerm, StrictInt, StrictFloat, VideoObject, date, SizeSpecification, Boolean, Country, Text, StrictBool, AggregateRating, AlignmentObject, ImageObject, CreativeWork, WebPage, Number, Language, Organization, Audience, Product, Demand, MusicRecording, Date, URL, AudioObject, Place, Duration, InteractionCounter, Event, Review, QuantitativeValue, int, Comment, Rating, MediaObject, PublicationEvent, AnyUrl, ItemList
    from pydantic_schemaorg import Event, Action, PropertyValue, TextObject, Text, URL, ImageObject, CreativeWork, AnyUrl
