...
class ArchiveOrganization(SchemaOrgBase):
    ...
    Model depth: 4
    """
    type_: str = Field(default="ArchiveOrganization", alias='@type')
    
    archiveHeld: Union[List[str], str] = Field(
        default=None,
        description="Collection, [fonds](https://en.wikipedia.org/wiki/Fonds), or item held, kept"
     "or maintained by an [[ArchiveOrganization]].",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import ArchiveComponent
