...
class ChemicalSubstance(SchemaOrgBase):
    ...
    chemicalComposition: Union[List[str], str] = Field(
        default=None,
        description="The chemical composition describes the identity and relative ratio of the chemical"
     "elements that make up the substance.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, DefinedTerm
