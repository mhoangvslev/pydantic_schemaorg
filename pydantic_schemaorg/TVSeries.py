...
class TVSeries(SchemaOrgBase):
    ...
    titleEIDR: Union[List[str], str] = Field(
        default=None,
...
if TYPE_CHECKING:
    from pydantic_schemaorg import MusicGroup, Organization, CreativeWorkSeason, Country, Episode, int, Person, Text, URL, Integer, AnyUrl, VideoObject
