...
class PronounceableText(SchemaOrgBase):
    ...
    phoneticText: Union[List[str], str] = Field(
        default=None,
        description="Representation of a text [[textValue]] using the specified [[speechToTextMarkup]]."
     "For example the city name of Houston in IPA: /ˈhjuːstən/.",union_mode="smart"
    )
    
    speechToTextMarkup: Union[List[str], str] = Field(
        default=None,
        description="Form of markup used. eg. [SSML](https://www.w3.org/TR/speech-synthesis11) or [IPA](https://www.wikidata.org/wiki/Property:P898).",union_mode="smart"
    )
    
    textValue: Union[List[str], str] = Field(
        default=None,
        description="Text value being annotated.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, Language
