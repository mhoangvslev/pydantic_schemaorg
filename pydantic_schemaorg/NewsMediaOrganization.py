...
class NewsMediaOrganization(SchemaOrgBase):
    ...
    noBylinesPolicy: Union[List[str], str] = Field(
        default=None,
        description="For a [[NewsMediaOrganization]] or other news-related [[Organization]], a statement"
     "explaining when authors of articles are not named in bylines.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, URL, AboutPage, CreativeWork, AnyUrl, Article
