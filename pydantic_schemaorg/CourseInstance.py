...
class CourseInstance(SchemaOrgBase):
    ...
    courseMode: Union[List[str], str] = Field(
        default=None,
     ...
     "(e.g. https://ceds.ed.gov/element/001311#Asynchronous).",union_mode="smart"
    )
    
    courseSchedule: Union[List[str], str] = Field(
        default=None,
        description="Represents the length and pace of a course, expressed as a [[Schedule]].",union_mode="smart"
    )
    
    courseWorkload: Union[List[str], str] = Field(
        default=None,
     ...
     "1 hour of lab work and 3 hours of independent study per week\".",union_mode="smart"
    )
    
    instructor: Union[List[str], str] = Field(
        default=None,
        description="A person assigned to instruct or provide instructional assistance for the [[CourseInstance]].",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, URL, Schedule, AnyUrl, Person
