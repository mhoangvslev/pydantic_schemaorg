...
class EducationalOccupationalCredential(SchemaOrgBase):
    ...
    recognizedBy: Union[List[str], str] = Field(
        default=None,
        description="An organization that acknowledges the validity, value or utility of a credential. Note:"
     "recognition may include a process of quality assurance or accreditation.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, URL, Organization, AnyUrl, DefinedTerm, Duration, AdministrativeArea
