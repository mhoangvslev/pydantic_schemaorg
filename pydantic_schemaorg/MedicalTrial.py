...
class MedicalTrial(SchemaOrgBase):
    ...
    trialDesign: Union[List[str], str] = Field(
        default=None,
        description="Specifics about the trial design (enumerated).",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import MedicalTrialDesign
