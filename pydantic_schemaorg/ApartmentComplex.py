...
class ApartmentComplex(SchemaOrgBase):
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Boolean, QuantitativeValue, Text, StrictBool, URL, Number, AnyUrl, StrictInt, StrictFloat
    from pydantic_schemaorg import FloorPlan
