...
class HyperToc(SchemaOrgBase):
    ...
    tocEntry: Union[List[str], str] = Field(
        default=None,
        description="Indicates a [[HyperTocEntry]] in a [[HyperToc]].",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import MediaObject, HyperTocEntry
