...
class RadioBroadcastService(SchemaOrgBase):
    ...
    hasBroadcastChannel: Union[List[str], str] = Field(
        default=None,
        description="A broadcast channel of a broadcast service.",union_mode="smart"
    )
    
    parentService: Union[List[str], str] = Field(
        default=None,
        description="A broadcast service to which the broadcast service may belong to such as regional variations"
     "of a national channel.",union_mode="smart"
    )
    ...
    area: Union[List[str], str] = Field(
        default=None,
        description="The area within which users can expect to reach the broadcast service.",union_mode="smart"
    )
    
    broadcastTimezone: Union[List[str], str] = Field(
        default=None,
        description="The timezone in [ISO 8601 format](http://en.wikipedia.org/wiki/ISO_8601) for which"
     "the service bases its broadcasts.",union_mode="smart"
    )
    
    broadcastAffiliateOf: Union[List[str], str] = Field(
        default=None,
        description="The media network(s) whose content is broadcast on this station.",union_mode="smart"
    )
    ...
    broadcastDisplayName: Union[List[str], str] = Field(
        default=None,
        description="The name displayed in the channel guide. For many US affiliates, it is the network name.",union_mode="smart"
    )
    
    broadcaster: Union[List[str], str] = Field(
        default=None,
        description="The organization owning or operating the broadcast service.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, Language, BroadcastChannel, Organization, BroadcastFrequencySpecification, Place, BroadcastService
