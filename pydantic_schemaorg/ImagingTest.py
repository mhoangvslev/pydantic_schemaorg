...
class ImagingTest(SchemaOrgBase):
    ...
    imagingTechnique: Union[List[str], str] = Field(
        default=None,
        description="Imaging technique used.",union_mode="smart"
    )
    
    signDetected: Union[List[str], str] = Field(
        default=None,
        description="A sign detected by the test.",union_mode="smart"
    )
    
    normalRange: Union[List[str], str] = Field(
        default=None,
        description="Range of acceptable values for a typical patient, when applicable.",union_mode="smart"
    )
    
    usesDevice: Union[List[str], str] = Field(
        default=None,
        description="Device used to perform the test.",union_mode="smart"
    )
    
    usedToDiagnose: Union[List[str], str] = Field(
        default=None,
        description="A condition the test is used to diagnose.",union_mode="smart"
    )
    
    affectedBy: Union[List[str], str] = Field(
        default=None,
        description="Drugs that affect the test's results.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import MedicalImagingTechnique
    from pydantic_schemaorg import Text, MedicalSign, MedicalEnumeration, Drug, MedicalCondition, MedicalDevice
