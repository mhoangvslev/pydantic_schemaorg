...
class UserComments(SchemaOrgBase):
    ...
    commentTime: Union[List[str], str] = Field(
        default=None,
        description="The time at which the UserComment was made.",union_mode="smart"
    )
    
    replyToUrl: Union[List[str], str] = Field(
        default=None,
        description="The URL at which a reply may be posted to the specified UserComment.",union_mode="smart"
    )
    
    commentText: Union[List[str], str] = Field(
        default=None,
        description="The text of the UserComment.",union_mode="smart"
    )
    ...
    discusses: Union[List[str], str] = Field(
        default=None,
        description="Specifies the CreativeWork associated with the UserComment.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import date, Organization, datetime, DateTime, Date, Person, Text, URL, CreativeWork, AnyUrl
