...
class ExerciseAction(SchemaOrgBase):
    ...
    sportsTeam: Union[List[str], str] = Field(
        default=None,
        description="A sub property of participant. The sports team that participated on this action.",union_mode="smart"
    )
    
    toLocation: Union[List[str], str] = Field(
        default=None,
        description="A sub property of location. The final location of the object or the agent after the action.",union_mode="smart"
    )
    
    opponent: Union[List[str], str] = Field(
        default=None,
        description="A sub property of participant. The opponent on this action.",union_mode="smart"
    )
    
    sportsActivityLocation: Union[List[str], str] = Field(
        default=None,
        description="A sub property of location. The sports activity location where this action occurred.",union_mode="smart"
    )
    
    fromLocation: Union[List[str], str] = Field(
        default=None,
        description="A sub property of location. The original location of the object or the agent before the"
     "action.",union_mode="smart"
    )
    
    exerciseType: Union[List[str], str] = Field(
        default=None,
        description="Type(s) of exercise or activity, such as strength training, flexibility training,"
     "aerobics, cardiac rehabilitation, etc.",union_mode="smart"
    )
    
    exerciseRelatedDiet: Union[List[str], str] = Field(
        default=None,
        description="A sub property of instrument. The diet used in this action.",union_mode="smart"
    )
    
    exerciseCourse: Union[List[str], str] = Field(
        default=None,
        description="A sub property of location. The course where this action was taken.",union_mode="smart"
    )
    
    course: Union[List[str], str] = Field(
        default=None,
        description="A sub property of location. The course where this action was taken.",union_mode="smart"
    )
    
    exercisePlan: Union[List[str], str] = Field(
        default=None,
        description="A sub property of instrument. The exercise plan used on this action.",union_mode="smart"
    )
    
    distance: Union[List[str], str] = Field(
        default=None,
        description="The distance travelled, e.g. exercising or travelling.",union_mode="smart"
    )
    
    diet: Union[List[str], str] = Field(
        default=None,
        description="A sub property of instrument. The diet used in this action.",union_mode="smart"
    )
    
    sportsEvent: Union[List[str], str] = Field(
        default=None,
        description="A sub property of location. The sports event where this action occurred.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Distance, SportsActivityLocation, Diet, SportsEvent, Person, Text, Place, ExercisePlan, SportsTeam
    from pydantic_schemaorg import Audience, Event
