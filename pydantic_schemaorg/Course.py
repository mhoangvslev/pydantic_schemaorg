...
class Course(SchemaOrgBase):
    ...
    coursePrerequisites: Union[List[str], str] = Field(
        default=None,
     ...
     "competency, referenced using [[AlignmentObject]].",union_mode="smart"
    )
    
    syllabusSections: Union[List[str], str] = Field(
        default=None,
        description="Indicates (typically several) Syllabus entities that lay out what each section of the"
     "overall course will cover.",union_mode="smart"
    )
    ...
    totalHistoricalEnrollment: Union[List[str], str] = Field(
        default=None,
        description="The total number of students that have enrolled in the history of the course.",union_mode="smart"
    )
    
    hasCourseInstance: Union[List[str], str] = Field(
        default=None,
        description="An offering of the course at a specific time and place or through specific media or mode"
     "of study or to a specific section of students.",union_mode="smart"
    )
    ...
    courseCode: Union[List[str], str] = Field(
        default=None,
        description="The identifier for the [[Course]] used by the course [[provider]] (e.g. CS101 or 6.001).",union_mode="smart"
    )
    ...
    competencyRequired: Union[List[str], str] = Field(
        default=None,
     ...
     "or understand a LearningResource.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Language, Syllabus, int, CourseInstance, Text, URL, EducationalOccupationalCredential, AlignmentObject, Integer, DefinedTerm, StructuredValue, AnyUrl, Course
    from pydantic_schemaorg import Text, URL, AlignmentObject, DefinedTerm, AnyUrl
