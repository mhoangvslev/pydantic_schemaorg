...
class BuyAction(SchemaOrgBase):
    ...
    vendor: Union[List[str], str] = Field(
        default=None,
        description="'vendor' is an earlier term for 'seller'.",union_mode="smart"
    )
    ...
    warrantyPromise: Union[List[str], str] = Field(
        default=None,
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Organization, WarrantyPromise, Person
