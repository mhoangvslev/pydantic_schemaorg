...
class EmployerAggregateRating(SchemaOrgBase):
    ...
    reviewCount: Union[List[str], str] = Field(
        default=None,
        description="The count of total number of reviews.",union_mode="smart"
    )
    ...
    ratingCount: Union[List[str], str] = Field(
        default=None,
        description="The count of total number of ratings.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Thing, Integer, int
