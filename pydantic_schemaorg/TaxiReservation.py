...
class TaxiReservation(SchemaOrgBase):
    ...
    partySize: Union[List[str], str] = Field(
        default=None,
        description="Number of people the reservation should accommodate.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Place, QuantitativeValue, DateTime, datetime, Integer, int
