...
class DrugCost(SchemaOrgBase):
    ...
    costPerUnit: Union[List[str], str] = Field(
        default=None,
        description="The cost per unit of the drug.",union_mode="smart"
    )
    ...
    applicableLocation: Union[List[str], str] = Field(
        default=None,
        description="The location in which the status applies.",union_mode="smart"
    )
    
    costCurrency: Union[List[str], str] = Field(
        default=None,
        description="The currency (in 3-letter) of the drug cost. See: http://en.wikipedia.org/wiki/ISO_4217.",union_mode="smart"
    )
    
    costCategory: Union[List[str], str] = Field(
        default=None,
        description="The category of cost, such as wholesale, retail, reimbursement cap, etc.",union_mode="smart"
    )
    
    costOrigin: Union[List[str], str] = Field(
        default=None,
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, DrugCostCategory, QualitativeValue, AdministrativeArea, Number, StrictInt, StrictFloat
