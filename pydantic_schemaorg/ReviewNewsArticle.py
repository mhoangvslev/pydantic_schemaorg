...
class ReviewNewsArticle(SchemaOrgBase):
    ...
    itemReviewed: Union[List[str], str] = Field(
        default=None,
        description="The item that is being reviewed/rated.",union_mode="smart"
    )
    
    associatedClaimReview: Union[List[str], str] = Field(
        default=None,
     ...
     "used on [[MediaReview]].",union_mode="smart"
    )
    ...
    associatedReview: Union[List[str], str] = Field(
        default=None,
        description="An associated [[Review]].",union_mode="smart"
    )
    
    reviewRating: Union[List[str], str] = Field(
        default=None,
     ...
     "the review itself, as a creative work.",union_mode="smart"
    )
    
    associatedMediaReview: Union[List[str], str] = Field(
        default=None,
    ...
    reviewBody: Union[List[str], str] = Field(
        default=None,
        description="The actual body of the review.",union_mode="smart"
    )
    ...
    printColumn: Union[List[str], str] = Field(
        default=None,
        description="The number of the column in which the NewsArticle appears in the print edition.",union_mode="smart"
    )
    
    dateline: Union[List[str], str] = Field(
        default=None,
     ...
     "\"QUEZON CITY, Philippines\".",union_mode="smart"
    )
    
    printPage: Union[List[str], str] = Field(
        default=None,
     ...
     "A5, B18).",union_mode="smart"
    )
    
    printEdition: Union[List[str], str] = Field(
        default=None,
        description="The edition of the print product in which the NewsArticle appears.",union_mode="smart"
    )
    
    printSection: Union[List[str], str] = Field(
        default=None,
        description="If this NewsArticle appears in print, this field indicates the print section in which"
     "the article appeared.",union_mode="smart"
    )
    
    pagination: Union[List[str], str] = Field(
        default=None,
        description="Any description of pages that is not separated into pageStart and pageEnd; for example,"
     "\"1-6, 9, 55\" or \"10-12, 46-49\".",union_mode="smart"
    )
    
    speakable: Union[List[str], str] = Field(
        default=None,
     ...
     "which is defined to be a possible value of the *speakable* property.",union_mode="smart"
    )
    
    articleBody: Union[List[str], str] = Field(
        default=None,
        description="The actual body of the article.",union_mode="smart"
    )
    
    backstory: Union[List[str], str] = Field(
        default=None,
     ...
     "interviews, data sources, etc.",union_mode="smart"
    )
    
    pageStart: Union[List[str], str] = Field(
        default=None,
        description="The page on which the work starts; for example \"135\" or \"xiii\".",union_mode="smart"
    )
    
    pageEnd: Union[List[str], str] = Field(
        default=None,
        description="The page on which the work ends; for example \"138\" or \"xvi\".",union_mode="smart"
    )
    
    articleSection: Union[List[str], str] = Field(
        default=None,
        description="Articles may belong to one or more 'sections' in a magazine or newspaper, such as Sports,"
     "Lifestyle, etc.",union_mode="smart"
    )
    
    wordCount: Union[List[str], str] = Field(
        default=None,
        description="The number of words in the text of the Article.",union_mode="smart"
    )
    

if TYPE_CHECKING:
    from pydantic_schemaorg import Text, WebContent, Review, Rating, Thing, ItemList, ListItem
    ...
    from pydantic_schemaorg import Text, URL, CreativeWork, Integer, int, SpeakableSpecification, AnyUrl
    from pydantic_schemaorg import Grant, datetime, DateTime, CorrectionComment, Claim, Thing, Offer, Person, Clip, Integer, DefinedTerm, StrictInt, StrictFloat, VideoObject, date, SizeSpecification, Boolean, Country, Text, StrictBool, AggregateRating, AlignmentObject, ImageObject, CreativeWork, WebPage, Number, Language, Organization, Audience, Product, Demand, MusicRecording, Date, URL, AudioObject, Place, Duration, InteractionCounter, Event, Review, QuantitativeValue, int, Comment, Rating, MediaObject, PublicationEvent, AnyUrl, ItemList
    from pydantic_schemaorg import Event, Action, PropertyValue, TextObject, Text, URL, ImageObject, CreativeWork, AnyUrl
