...
class VideoObjectSnapshot(SchemaOrgBase):
    ...
    videoFrameSize: Union[List[str], str] = Field(
        default=None,
        description="The frame size of the video.",union_mode="smart"
    )
    ...
    videoQuality: Union[List[str], str] = Field(
        default=None,
        description="The quality of the video.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, MediaObject, MusicGroup, Person
