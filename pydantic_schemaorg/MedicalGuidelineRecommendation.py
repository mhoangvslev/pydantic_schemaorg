...
class MedicalGuidelineRecommendation(SchemaOrgBase):
    ...
    recommendationStrength: Union[List[str], str] = Field(
        default=None,
        description="Strength of the guideline's recommendation (e.g. 'class I').",union_mode="smart"
    )
    
    evidenceLevel: Union[List[str], str] = Field(
        default=None,
        description="Strength of evidence of the data used to formulate the guideline (enumerated).",union_mode="smart"
    )
    
    guidelineSubject: Union[List[str], str] = Field(
        default=None,
        description="The medical conditions, treatments, etc. that are the subject of the guideline.",union_mode="smart"
    )
    
    guidelineDate: Union[List[str], str] = Field(
        default=None,
        description="Date on which this guideline's recommendation was made.",union_mode="smart"
    )
    
    evidenceOrigin: Union[List[str], str] = Field(
        default=None,
        description="Source of the data used to formulate the guidance, e.g. RCT, consensus opinion, etc.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    ...
    from pydantic_schemaorg import MedicalEntity, Text, date, MedicalEvidenceLevel, Date
