...
class Physician(SchemaOrgBase):
    ...
    medicalSpecialty: Union[List[str], str] = Field(
        default=None,
        description="A medical specialty of the provider.",union_mode="smart"
    )
    
    hospitalAffiliation: Union[List[str], str] = Field(
        default=None,
        description="A hospital with which the physician or office is affiliated.",union_mode="smart"
    )
    
    availableService: Union[List[str], str] = Field(
        default=None,
        description="A medical service available from this provider.",union_mode="smart"
    )
    ...
    isAcceptingNewPatients: Union[List[str], str] = Field(
        default=None,
        description="Whether the provider is accepting new patients.",union_mode="smart"
    )
    
    healthPlanNetworkId: Union[List[str], str] = Field(
        default=None,
        description="Name or unique ID of network. (Networks are often reused across different insurance"
     "plans.)",union_mode="smart"
    )
    

if TYPE_CHECKING:
    from pydantic_schemaorg import MedicalTest, MedicalSpecialty, MedicalTherapy, MedicalProcedure, Hospital
    ...
    from pydantic_schemaorg import Event, Action, PropertyValue, TextObject, Text, URL, ImageObject, CreativeWork, AnyUrl
    from pydantic_schemaorg import Text, StrictBool, MedicalSpecialty, Boolean
    from pydantic_schemaorg import Grant, GeoShape, NonprofitType, Offer, Thing, Person, ProductReturnPolicy, Brand, ProgramMembership, AboutPage, DefinedTerm, date, OwnershipInfo, Text, EducationalOccupationalCredential, AggregateRating, ImageObject, CreativeWork, Language, Organization, MerchantReturnPolicy, Product, Demand, Date, URL, Place, AdministrativeArea, PostalAddress, InteractionCounter, Event, Review, AnyUrl, QuantitativeValue, OfferCatalog, VirtualLocation, ContactPoint, Article
    from pydantic_schemaorg import Event, Action, PropertyValue, TextObject, Text, URL, ImageObject, CreativeWork, AnyUrl
