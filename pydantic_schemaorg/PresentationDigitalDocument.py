...
class PresentationDigitalDocument(SchemaOrgBase):
    ...
    hasDigitalDocumentPermission: Union[List[str], str] = Field(
        default=None,
     ...
     "audienceType equal to \"public\".",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import DigitalDocumentPermission
