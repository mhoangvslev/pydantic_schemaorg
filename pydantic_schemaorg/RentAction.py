...
class RentAction(SchemaOrgBase):
    ...
    landlord: Union[List[str], str] = Field(
        default=None,
        description="A sub property of participant. The owner of the real estate property.",union_mode="smart"
    )
    
    realEstateAgent: Union[List[str], str] = Field(
        default=None,
        description="A sub property of participant. The real estate agent involved in the action.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Organization, RealEstateAgent, Person
