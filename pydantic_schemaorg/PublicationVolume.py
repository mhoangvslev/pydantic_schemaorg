...
class PublicationVolume(SchemaOrgBase):
    ...
    volumeNumber: Union[List[str], str] = Field(
        default=None,
        description="Identifies the volume of publication or multi-part work; for example, \"iii\" or \"2\".",union_mode="smart"
    )
