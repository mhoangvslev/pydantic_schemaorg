...
class TVEpisode(SchemaOrgBase):
    ...
    partOfTVSeries: Union[List[str], str] = Field(
        default=None,
        description="The TV series to which this episode or season belongs.",union_mode="smart"
    )
    
    subtitleLanguage: Union[List[str], str] = Field(
        default=None,
        description="Languages in which subtitles/captions are available, in [IETF BCP 47 standard format](http://tools.ietf.org/html/bcp47).",union_mode="smart"
    )
    ...
    partOfSeason: Union[List[str], str] = Field(
        default=None,
        description="The season to which this episode belongs.",union_mode="smart"
    )
    ...
    partOfSeries: Union[List[str], str] = Field(
        default=None,
        description="The series to which this episode or season belongs.",union_mode="smart"
    )
    ...
    episodeNumber: Union[List[str], str] = Field(
        default=None,
        description="Position of the episode within an ordered group of episodes.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, Language, TVSeries, URL, Country, AnyUrl
    from pydantic_schemaorg import MusicGroup, Organization, CreativeWorkSeason, CreativeWorkSeries, int, Person, Text, Integer, Duration, VideoObject
