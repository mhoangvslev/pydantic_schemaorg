...
class RadioSeries(SchemaOrgBase):
...
if TYPE_CHECKING:
    from pydantic_schemaorg import MusicGroup, Integer, Organization, Episode, int, Person, URL, CreativeWorkSeason, AnyUrl, VideoObject
