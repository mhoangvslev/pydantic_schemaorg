...
class MerchantReturnPolicySeasonalOverride(SchemaOrgBase):
...
if TYPE_CHECKING:
    from pydantic_schemaorg import date, datetime, MerchantReturnEnumeration, DateTime, Integer, int, Date
