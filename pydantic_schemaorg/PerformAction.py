...
class PerformAction(SchemaOrgBase):
    ...
    entertainmentBusiness: Union[List[str], str] = Field(
        default=None,
        description="A sub property of location. The entertainment business where the action occurred.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import EntertainmentBusiness
