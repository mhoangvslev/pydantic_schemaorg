...
class TrainTrip(SchemaOrgBase):
    ...
    departurePlatform: Union[List[str], str] = Field(
        default=None,
        description="The platform from which the train departs.",union_mode="smart"
    )
    
    trainNumber: Union[List[str], str] = Field(
        default=None,
        description="The unique identifier for the train.",union_mode="smart"
    )
    
    trainName: Union[List[str], str] = Field(
        default=None,
        description="The name of the train (e.g. The Orient Express).",union_mode="smart"
    )
    
    arrivalStation: Union[List[str], str] = Field(
        default=None,
        description="The station where the train trip ends.",union_mode="smart"
    )
    
    arrivalPlatform: Union[List[str], str] = Field(
        default=None,
        description="The platform where the train arrives.",union_mode="smart"
    )
    
    departureStation: Union[List[str], str] = Field(
        default=None,
        description="The station from which the train departs.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, TrainStation
