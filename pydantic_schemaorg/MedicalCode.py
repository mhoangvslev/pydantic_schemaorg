...
class MedicalCode(SchemaOrgBase):
    ...
    codeValue: Union[List[str], str] = Field(
        default=None,
        description="A short textual code that uniquely identifies the value.",union_mode="smart"
    )
    
    codingSystem: Union[List[str], str] = Field(
        default=None,
        description="The coding system, e.g. 'ICD-10'.",union_mode="smart"
    )
    
    inCodeSet: Union[List[str], str] = Field(
        default=None,
        description="A [[CategoryCodeSet]] that contains this category code.",union_mode="smart"
    )
    
    inDefinedTermSet: Union[List[str], str] = Field(
        default=None,
        description="A [[DefinedTermSet]] that contains this term.",union_mode="smart"
    )
    
    termCode: Union[List[str], str] = Field(
        default=None,
        description="A code that identifies this [[DefinedTerm]] within a [[DefinedTermSet]].",union_mode="smart"
    )
...
if TYPE_CHECKING:
    ...
    from pydantic_schemaorg import Text, URL, CategoryCodeSet, AnyUrl
    from pydantic_schemaorg import Text, URL, DefinedTermSet, AnyUrl
