...
class SoftwareSourceCode(SchemaOrgBase):
    ...
    codeSampleType: Union[List[str], str] = Field(
        default=None,
        description="What type of code sample: full (compile ready) solution, code snippet, inline code,"
     "scripts, template.",union_mode="smart"
    )
    
    runtimePlatform: Union[List[str], str] = Field(
        default=None,
        description="Runtime platform or script interpreter dependencies (example: Java v1, Python 2.3,"
     ".NET Framework 3.0).",union_mode="smart"
    )
    
    targetProduct: Union[List[str], str] = Field(
        default=None,
        description="Target Operating System / Product to which the code applies. If applies to several versions,"
     "just the product name can be used.",union_mode="smart"
    )
    
    runtime: Union[List[str], str] = Field(
        default=None,
        description="Runtime platform or script interpreter dependencies (example: Java v1, Python 2.3,"
     ".NET Framework 3.0).",union_mode="smart"
    )
    
    programmingLanguage: Union[List[str], str] = Field(
        default=None,
        description="The computer programming language.",union_mode="smart"
    )
    
    codeRepository: Union[List[str], str] = Field(
        default=None,
        description="Link to the repository where the un-compiled, human readable code and related code is"
     "located (SVN, GitHub, CodePlex).",union_mode="smart"
    )
    
    sampleType: Union[List[str], str] = Field(
        default=None,
        description="What type of code sample: full (compile ready) solution, code snippet, inline code,"
     "scripts, template.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, SoftwareApplication, URL, ComputerLanguage, AnyUrl
