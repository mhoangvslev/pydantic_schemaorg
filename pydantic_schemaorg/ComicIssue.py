...
class ComicIssue(SchemaOrgBase):
    ...
    variantCover: Union[List[str], str] = Field(
        default=None,
        description="A description of the variant cover for the issue, if the issue is a variant printing. For"
     "example, \"Bryan Hitch Variant Cover\" or \"2nd Printing Variant\".",union_mode="smart"
    )
    ...
    issueNumber: Union[List[str], str] = Field(
        default=None,
        description="Identifies the issue of publication; for example, \"iii\" or \"2\".",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, Person
    from pydantic_schemaorg import Text, Integer, int
