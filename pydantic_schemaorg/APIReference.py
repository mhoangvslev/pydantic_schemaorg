...
class APIReference(SchemaOrgBase):
    ...
    targetPlatform: Union[List[str], str] = Field(
        default=None,
        description="Type of app development: phone, Metro style, desktop, XBox, etc.",union_mode="smart"
    )
    
    programmingModel: Union[List[str], str] = Field(
        default=None,
        description="Indicates whether API is managed or unmanaged.",union_mode="smart"
    )
    
    assemblyVersion: Union[List[str], str] = Field(
        default=None,
        description="Associated product/technology version. E.g., .NET Framework 4.5.",union_mode="smart"
    )
    
    assembly: Union[List[str], str] = Field(
        default=None,
        description="Library file name, e.g., mscorlib.dll, system.web.dll.",union_mode="smart"
    )
    
    executableLibraryName: Union[List[str], str] = Field(
        default=None,
        description="Library file name, e.g., mscorlib.dll, system.web.dll.",union_mode="smart"
    )
    
    dependencies: Union[List[str], str] = Field(
        default=None,
        description="Prerequisites needed to fulfill steps in article.",union_mode="smart"
    )
    
    proficiencyLevel: Union[List[str], str] = Field(
        default=None,
        description="Proficiency needed for this content; expected values: 'Beginner', 'Expert'.",union_mode="smart"
    )
