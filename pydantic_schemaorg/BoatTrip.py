...
class BoatTrip(SchemaOrgBase):
    ...
    departureBoatTerminal: Union[List[str], str] = Field(
        default=None,
        description="The terminal or port from which the boat departs.",union_mode="smart"
    )
    
    arrivalBoatTerminal: Union[List[str], str] = Field(
        default=None,
        description="The terminal or port from which the boat arrives.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import BoatTerminal
