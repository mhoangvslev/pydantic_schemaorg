...
class ClaimReview(SchemaOrgBase):
    ...
    claimReviewed: Union[List[str], str] = Field(
        default=None,
        description="A short summary of the specific claims reviewed in a ClaimReview.",union_mode="smart"
    )
