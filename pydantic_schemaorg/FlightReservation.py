...
class FlightReservation(SchemaOrgBase):
    ...
    securityScreening: Union[List[str], str] = Field(
        default=None,
        description="The type of security screening the passenger is subject to.",union_mode="smart"
    )
    
    passengerPriorityStatus: Union[List[str], str] = Field(
        default=None,
        description="The priority status assigned to a passenger for security or boarding (e.g. FastTrack"
     "or Priority).",union_mode="smart"
    )
    
    passengerSequenceNumber: Union[List[str], str] = Field(
        default=None,
        description="The passenger's sequence number as assigned by the airline.",union_mode="smart"
    )
    
    boardingGroup: Union[List[str], str] = Field(
        default=None,
        description="The airline-specific indicator of boarding order / preference.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, QualitativeValue
