...
class MusicGroup(SchemaOrgBase):
    ...
    musicGroupMember: Union[List[str], str] = Field(
        default=None,
        description="A member of a music group&#x2014;for example, John, Paul, George, or Ringo.",union_mode="smart"
    )
    
    album: Union[List[str], str] = Field(
        default=None,
        description="A music album.",union_mode="smart"
    )
    ...
    albums: Union[List[str], str] = Field(
        default=None,
        description="A collection of music albums.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, URL, ItemList, MusicAlbum, MusicRecording, AnyUrl, Person
