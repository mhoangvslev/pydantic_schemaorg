...
class RecommendedDoseSchedule(SchemaOrgBase):
    ...
    frequency: Union[List[str], str] = Field(
        default=None,
        description="How often the dose is taken, e.g. 'daily'.",union_mode="smart"
    )
    
    doseValue: Union[List[str], str] = Field(
        default=None,
        description="The value of the dose, e.g. 500.",union_mode="smart"
    )
    
    doseUnit: Union[List[str], str] = Field(
        default=None,
        description="The unit of the dose, e.g. 'mg'.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, QualitativeValue, Number, StrictInt, StrictFloat
