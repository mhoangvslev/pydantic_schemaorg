...
class MedicalScholarlyArticle(SchemaOrgBase):
    ...
    publicationType: Union[List[str], str] = Field(
        default=None,
        description="The type of the medical article, taken from the US NLM MeSH publication type catalog."
     "See also [MeSH documentation](http://www.nlm.nih.gov/mesh/pubtypes.html).",union_mode="smart"
    )
