...
class BusinessAudience(SchemaOrgBase):
    ...
    yearsInOperation: Union[List[str], str] = Field(
        default=None,
        description="The age of the business.",union_mode="smart"
    )
    ...
    yearlyRevenue: Union[List[str], str] = Field(
        default=None,
        description="The size of the business in annual revenue.",union_mode="smart"
    )
