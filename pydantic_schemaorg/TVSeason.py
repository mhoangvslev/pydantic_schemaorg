...
class TVSeason(SchemaOrgBase):
    ...
    seasonNumber: Union[List[str], str] = Field(
        default=None,
        description="Position of the season within an ordered group of seasons.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, TVSeries, URL, Country, AnyUrl
    from pydantic_schemaorg import date, Organization, datetime, DateTime, Episode, CreativeWorkSeries, int, Date, Person, Text, Integer, VideoObject
