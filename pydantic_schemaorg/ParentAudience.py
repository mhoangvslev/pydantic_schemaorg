...
class ParentAudience(SchemaOrgBase):
    ...
    childMinAge: Union[List[str], str] = Field(
        default=None,
        description="Minimal age of the child.",union_mode="smart"
    )
    
    childMaxAge: Union[List[str], str] = Field(
        default=None,
        description="Maximal age of the child.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import StrictInt, StrictFloat, Number
