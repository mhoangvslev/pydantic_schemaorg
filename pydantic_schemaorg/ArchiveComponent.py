...
class ArchiveComponent(SchemaOrgBase):
    ...
    itemLocation: Union[List[str], str] = Field(
        default=None,
        description="Current location of the item.",union_mode="smart"
    )
    
    holdingArchive: Union[List[str], str] = Field(
        default=None,
        description="[[ArchiveOrganization]] that holds, keeps or maintains the [[ArchiveComponent]].",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, ArchiveOrganization, Place, PostalAddress
