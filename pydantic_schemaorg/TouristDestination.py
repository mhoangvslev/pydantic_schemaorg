...
class TouristDestination(SchemaOrgBase):
    ...
    touristType: Union[List[str], str] = Field(
        default=None,
        description="Attraction suitable for type(s) of tourist. E.g. children, visitors from a particular"
     "country, etc.",union_mode="smart"
    )
    
    includesAttraction: Union[List[str], str] = Field(
        default=None,
        description="Attraction located at destination.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, Audience, TouristAttraction
