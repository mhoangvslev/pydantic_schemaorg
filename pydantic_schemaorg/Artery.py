...
class Artery(SchemaOrgBase):
    ...
    supplyTo: Union[List[str], str] = Field(
        default=None,
        description="The area to which the artery supplies blood.",union_mode="smart"
    )
    
    arterialBranch: Union[List[str], str] = Field(
        default=None,
        description="The branches that comprise the arterial structure.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import AnatomicalStructure
