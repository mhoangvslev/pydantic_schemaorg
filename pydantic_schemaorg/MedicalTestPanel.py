...
class MedicalTestPanel(SchemaOrgBase):
    ...
    subTest: Union[List[str], str] = Field(
        default=None,
        description="A component test of the panel.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import MedicalTest
