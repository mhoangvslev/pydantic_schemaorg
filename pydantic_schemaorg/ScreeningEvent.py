...
class ScreeningEvent(SchemaOrgBase):
    ...
    workPresented: Union[List[str], str] = Field(
        default=None,
        description="The movie presented during this event.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, Movie, Language
