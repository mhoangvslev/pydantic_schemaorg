...
class Blog(SchemaOrgBase):
    ...
    blogPosts: Union[List[str], str] = Field(
        default=None,
     ...
     "referred to as a \"blog\".",union_mode="smart"
    )
    
    blogPost: Union[List[str], str] = Field(
        default=None,
        description="A posting that is part of this blog.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, BlogPosting
