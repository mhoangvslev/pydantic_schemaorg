...
class AnatomicalSystem(SchemaOrgBase):
    ...
    comprisedOf: Union[List[str], str] = Field(
        default=None,
    ...
    relatedStructure: Union[List[str], str] = Field(
        default=None,
        description="Related anatomical structure(s) that are not part of the system but relate or connect"
     "to it, such as vascular bundles associated with an organ system.",union_mode="smart"
    )
