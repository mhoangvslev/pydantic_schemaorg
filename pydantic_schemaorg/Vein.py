...
class Vein(SchemaOrgBase):
    ...
    drainsTo: Union[List[str], str] = Field(
        default=None,
        description="The vasculature that the vein drains into.",union_mode="smart"
    )
