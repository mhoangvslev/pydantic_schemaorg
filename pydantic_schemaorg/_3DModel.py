...
class _3DModel(SchemaOrgBase):
    ...
    isResizable: Union[List[str], str] = Field(
        default=None,
        description="Whether the 3DModel allows resizing. For example, room layout applications often do"
     "not allow 3DModel elements to be resized to reflect reality.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import StrictBool, Boolean
