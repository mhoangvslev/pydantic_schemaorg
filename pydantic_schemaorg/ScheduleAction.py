...
class ScheduleAction(SchemaOrgBase):
    ...
    scheduledTime: Union[List[str], str] = Field(
        default=None,
        description="The time the object is scheduled to.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import date, datetime, DateTime, Date
