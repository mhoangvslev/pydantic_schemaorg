...
class Joint(SchemaOrgBase):
    ...
    structuralClass: Union[List[str], str] = Field(
        default=None,
        description="The name given to how bone physically connects to each other.",union_mode="smart"
    )
    
    functionalClass: Union[List[str], str] = Field(
        default=None,
        description="The degree of mobility the joint allows.",union_mode="smart"
    )
    
    biomechnicalClass: Union[List[str], str] = Field(
        default=None,
        description="The biomechanical properties of the bone.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, MedicalEntity
