...
class ProductGroup(SchemaOrgBase):
    ...
    hasVariant: Union[List[str], str] = Field(
        default=None,
        description="Indicates a [[Product]] that is a member of this [[ProductGroup]] (or [[ProductModel]]).",union_mode="smart"
    )
    
    productGroupID: Union[List[str], str] = Field(
        default=None,
        description="Indicates a textual identifier for a ProductGroup.",union_mode="smart"
    )
    
    variesBy: Union[List[str], str] = Field(
        default=None,
     ...
     "e.g. \"color\"; terms defined elsewhere can be referenced with their URIs.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, DefinedTerm, Product
