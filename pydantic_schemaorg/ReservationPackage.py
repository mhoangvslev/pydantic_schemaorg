...
class ReservationPackage(SchemaOrgBase):
    ...
    subReservation: Union[List[str], str] = Field(
        default=None,
        description="The individual reservations included in the package. Typically a repeated property.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Reservation
