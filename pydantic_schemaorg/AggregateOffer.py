...
class AggregateOffer(SchemaOrgBase):
    ...
    offerCount: Union[List[str], str] = Field(
        default=None,
        description="The number of offers for the product.",union_mode="smart"
    )
    ...
    lowPrice: Union[List[str], str] = Field(
        default=None,
     ...
     "indicate a decimal point. Avoid using these symbols as a readability separator.",union_mode="smart"
    )
    
    highPrice: Union[List[str], str] = Field(
        default=None,
    ...
    leaseLength: Union[List[str], str] = Field(
        default=None,
        description="Length of the lease for some [[Accommodation]], either particular to some [[Offer]]"
     "or in some cases intrinsic to the property.",union_mode="smart"
    )
    ...
    addOn: Union[List[str], str] = Field(
        default=None,
        description="An additional offer that can only be obtained in combination with the first base offer"
     "(e.g. supplements and extensions that are available for a surcharge).",union_mode="smart"
    )
    ...
    checkoutPageURLTemplate: Union[List[str], str] = Field(
        default=None,
     ...
     "and standardization are not specified here.",union_mode="smart"
    )
    ...
    shippingDetails: Union[List[str], str] = Field(
        default=None,
        description="Indicates information about the shipping policies and options associated with an [[Offer]].",union_mode="smart"
    )
    ...
    offeredBy: Union[List[str], str] = Field(
        default=None,
        description="A pointer to the organization or person making the offer.",union_mode="smart"
    )
    ...
    priceValidUntil: Union[List[str], str] = Field(
        default=None,
        description="The date after which the price is no longer available.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, StrictInt, StrictFloat, int, Demand, Integer, Offer, Number
    from pydantic_schemaorg import GeoShape, datetime, DeliveryMethod, DateTime, Service, Time, Offer, PhysicalActivityCategory, Thing, Person, BusinessFunction, time, CategoryCode, StrictInt, StrictFloat, date, Trip, Boolean, AggregateOffer, Text, StrictBool, AggregateRating, ItemAvailability, WarrantyPromise, CreativeWork, Number, Product, MerchantReturnPolicy, Organization, PriceSpecification, AdultOrientedEnumeration, BusinessEntityType, Date, TypeAndQuantityNode, URL, Place, Duration, AdministrativeArea, Event, Review, QuantitativeValue, OfferShippingDetails, LoanOrCredit, MenuItem, OfferItemCondition, PaymentMethod, AnyUrl
