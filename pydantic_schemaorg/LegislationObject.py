...
class LegislationObject(SchemaOrgBase):
    ...
    legislationLegalValue: Union[List[str], str] = Field(
        default=None,
     ...
     "legal value than the HTML file of the same act.",union_mode="smart"
    )
    
    uploadDate: Union[List[str], str] = Field(
        default=None,
        description="Date (including time if available) when this media object was uploaded to this site.",union_mode="smart"
    )
    
    sha256: Union[List[str], str] = Field(
        default=None,
        description="The [SHA-2](https://en.wikipedia.org/wiki/SHA-2) SHA256 hash of the content of"
     "the item. For example, a zero-length input has value 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855'.",union_mode="smart"
    )
    
    playerType: Union[List[str], str] = Field(
        default=None,
        description="Player type required&#x2014;for example, Flash or Silverlight.",union_mode="smart"
    )
    
    bitrate: Union[List[str], str] = Field(
        default=None,
        description="The bitrate of the media object.",union_mode="smart"
    )
    
    contentSize: Union[List[str], str] = Field(
        default=None,
        description="File size in (mega/kilo)bytes.",union_mode="smart"
    )
    ...
    encodesCreativeWork: Union[List[str], str] = Field(
        default=None,
        description="The CreativeWork encoded by this media object.",union_mode="smart"
    )
    ...
    embedUrl: Union[List[str], str] = Field(
        default=None,
     ...
     "the ```loc``` tag.",union_mode="smart"
    )
    
    regionsAllowed: Union[List[str], str] = Field(
        default=None,
        description="The regions where the media is allowed. If not specified, then it's assumed to be allowed"
     "everywhere. Specify the countries in [ISO 3166 format](http://en.wikipedia.org/wiki/ISO_3166).",union_mode="smart"
    )
    
    productionCompany: Union[List[str], str] = Field(
        default=None,
        description="The production company or studio responsible for the item, e.g. series, video game,"
     "episode etc.",union_mode="smart"
    )
    
    associatedArticle: Union[List[str], str] = Field(
        default=None,
        description="A NewsArticle associated with the Media Object.",union_mode="smart"
    )
    ...
    contentUrl: Union[List[str], str] = Field(
        default=None,
        description="Actual bytes of the media object, for example the image file or video file.",union_mode="smart"
    )
    ...
    legislationLegalForce: Union[List[str], str] = Field(
        default=None,
        description="Whether the legislation is currently in force, not in force, or partially in force.",union_mode="smart"
    )
    
    legislationDateVersion: Union[List[str], str] = Field(
        default=None,
     ...
     "2015-04-12 of the \"National Insurance Contributions Act 2015\")",union_mode="smart"
    )
    
    legislationPassedBy: Union[List[str], str] = Field(
        default=None,
     ...
     "the \"legal author\" of the law, as opposed to its physical author.",union_mode="smart"
    )
    
    legislationChanges: Union[List[str], str] = Field(
        default=None,
    ...
    legislationJurisdiction: Union[List[str], str] = Field(
        default=None,
        description="The jurisdiction from which the legislation originates.",union_mode="smart"
    )
    
    legislationConsolidates: Union[List[str], str] = Field(
        default=None,
     ...
     "previous consolidated version, and to the legislations making the change.",union_mode="smart"
    )
    ...
    legislationTransposes: Union[List[str], str] = Field(
        default=None,
     ...
     "Directives. This indicates a legally binding link between the 2 legislations.",union_mode="smart"
    )
    
    legislationDate: Union[List[str], str] = Field(
        default=None,
     ...
     "or in force.",union_mode="smart"
    )
    
    legislationIdentifier: Union[List[str], str] = Field(
        default=None,
     ...
     "ELI (European Legislation Identifier) or an URN-Lex.",union_mode="smart"
    )
    
    legislationApplies: Union[List[str], str] = Field(
        default=None,
     ...
     "in it.",union_mode="smart"
    )
    
    legislationType: Union[List[str], str] = Field(
        default=None,
     ...
     "grand-ducal\", etc., depending on the country.",union_mode="smart"
    )
    
    legislationResponsible: Union[List[str], str] = Field(
        default=None,
     ...
     "for potential questions about the legislation once it is published.",union_mode="smart"
    )
    

if TYPE_CHECKING:
    from pydantic_schemaorg import LegalValueLevel
    from pydantic_schemaorg import Organization, GeoShape, datetime, DateTime, Claim, Date, Time, URL, time, Place, NewsArticle, Duration, date, Distance, Boolean, QuantitativeValue, MediaSubscription, Text, StrictBool, CreativeWork, AnyUrl
    ...
    from pydantic_schemaorg import CategoryCode, date, Organization, Legislation, Date, Person, Text, URL, LegalForceStatus, AnyUrl, AdministrativeArea
    from pydantic_schemaorg import Grant, datetime, DateTime, CorrectionComment, Claim, Thing, Offer, Person, Clip, Integer, DefinedTerm, StrictInt, StrictFloat, VideoObject, date, SizeSpecification, Boolean, Country, Text, StrictBool, AggregateRating, AlignmentObject, ImageObject, CreativeWork, WebPage, Number, Language, Organization, Audience, Product, Demand, MusicRecording, Date, URL, AudioObject, Place, Duration, InteractionCounter, Event, Review, QuantitativeValue, int, Comment, Rating, MediaObject, PublicationEvent, AnyUrl, ItemList
    from pydantic_schemaorg import Event, Action, PropertyValue, TextObject, Text, URL, ImageObject, CreativeWork, AnyUrl
