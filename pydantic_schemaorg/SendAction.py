...
class SendAction(SchemaOrgBase):
    ...
    deliveryMethod: Union[List[str], str] = Field(
        default=None,
        description="A sub property of instrument. The method of delivery.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Audience, Organization, DeliveryMethod, ContactPoint, Person
    from pydantic_schemaorg import Place
