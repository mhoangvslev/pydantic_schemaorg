...
class SizeSpecification(SchemaOrgBase):
    ...
    sizeSystem: Union[List[str], str] = Field(
        default=None,
     ...
     "system (for example \"Metric\" or \"Imperial\").",union_mode="smart"
    )
    ...
    sizeGroup: Union[List[str], str] = Field(
        default=None,
     ...
     "maternity\" or \"regular\".",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, SizeSystemEnumeration, GenderType, SizeGroupEnumeration, QuantitativeValue
