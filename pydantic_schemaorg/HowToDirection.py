...
class HowToDirection(SchemaOrgBase):
    ...
    duringMedia: Union[List[str], str] = Field(
        default=None,
        description="A media object representing the circumstances while performing this direction.",union_mode="smart"
    )
    ...
    afterMedia: Union[List[str], str] = Field(
        default=None,
        description="A media object representing the circumstances after performing this direction.",union_mode="smart"
    )
    ...
    beforeMedia: Union[List[str], str] = Field(
        default=None,
        description="A media object representing the circumstances before performing this direction.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, MediaObject, URL, HowToTool, HowToSupply, Duration, AnyUrl
