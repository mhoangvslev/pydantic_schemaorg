...
class LiveBlogPosting(SchemaOrgBase):
    ...
    coverageStartTime: Union[List[str], str] = Field(
        default=None,
     ...
     "begins.",union_mode="smart"
    )
    
    liveBlogUpdate: Union[List[str], str] = Field(
        default=None,
        description="An update to the LiveBlog.",union_mode="smart"
    )
    
    coverageEndTime: Union[List[str], str] = Field(
        default=None,
        description="The time when the live blog will stop covering the Event. Note that coverage may continue"
     "after the Event concludes.",union_mode="smart"
    )
    
    sharedContent: Union[List[str], str] = Field(
        default=None,
        description="A CreativeWork such as an image, video, or audio clip shared as part of this posting.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import BlogPosting, datetime, DateTime
    from pydantic_schemaorg import CreativeWork
