...
class MedicalRiskScore(SchemaOrgBase):
    ...
    algorithm: Union[List[str], str] = Field(
        default=None,
        description="The algorithm or rules to follow to compute the score.",union_mode="smart"
    )
    
    includedRiskFactor: Union[List[str], str] = Field(
        default=None,
    ...
    estimatesRiskOf: Union[List[str], str] = Field(
        default=None,
        description="The condition, complication, or symptom whose risk is being estimated.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    ...
    from pydantic_schemaorg import MedicalEntity, MedicalRiskFactor
