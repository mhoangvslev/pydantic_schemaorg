...
class Thesis(SchemaOrgBase):
    ...
    inSupportOf: Union[List[str], str] = Field(
        default=None,
        description="Qualification, candidature, degree, application that Thesis supports.",union_mode="smart"
    )
