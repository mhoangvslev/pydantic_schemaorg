...
class BedDetails(SchemaOrgBase):
    ...
    numberOfBeds: Union[List[str], str] = Field(
        default=None,
        description="The quantity of the given bed type available in the HotelRoom, Suite, House, or Apartment.",union_mode="smart"
    )
    
    typeOfBed: Union[List[str], str] = Field(
        default=None,
        description="The type of bed to which the BedDetail refers, i.e. the type of bed available in the quantity"
     "indicated by quantity.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, StrictInt, StrictFloat, Number, BedType
