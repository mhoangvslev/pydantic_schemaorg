...
class Drug(SchemaOrgBase):
    ...
    prescriptionStatus: Union[List[str], str] = Field(
        default=None,
        description="Indicates the status of drug prescription, e.g. local catalogs classifications or"
     "whether the drug is available by prescription or over-the-counter, etc.",union_mode="smart"
    )
    
    foodWarning: Union[List[str], str] = Field(
        default=None,
        description="Any precaution, guidance, contraindication, etc. related to consumption of specific"
     "foods while taking this drug.",union_mode="smart"
    )
    
    includedInHealthInsurancePlan: Union[List[str], str] = Field(
        default=None,
        description="The insurance plans that cover this drug.",union_mode="smart"
    )
    
    drugUnit: Union[List[str], str] = Field(
        default=None,
        description="The unit in which the drug is measured, e.g. '5 mg tablet'.",union_mode="smart"
    )
    
    pregnancyWarning: Union[List[str], str] = Field(
        default=None,
        description="Any precaution, guidance, contraindication, etc. related to this drug's use during"
     "pregnancy.",union_mode="smart"
    )
    
    proprietaryName: Union[List[str], str] = Field(
        default=None,
        description="Proprietary name given to the diet plan, typically by its originator or creator.",union_mode="smart"
    )
    ...
    clinicalPharmacology: Union[List[str], str] = Field(
        default=None,
        description="Description of the absorption and elimination of drugs, including their concentration"
     "(pharmacokinetics, pK) and biological effects (pharmacodynamics, pD).",union_mode="smart"
    )
    
    overdosage: Union[List[str], str] = Field(
        default=None,
        description="Any information related to overdose on a drug, including signs or symptoms, treatments,"
     "contact information for emergency response.",union_mode="smart"
    )
    
    isProprietary: Union[List[str], str] = Field(
        default=None,
        description="True if this item's name is a proprietary/brand name (vs. generic name).",union_mode="smart"
    )
    
    alcoholWarning: Union[List[str], str] = Field(
        default=None,
        description="Any precaution, guidance, contraindication, etc. related to consumption of alcohol"
     "while taking this drug.",union_mode="smart"
    )
    
    administrationRoute: Union[List[str], str] = Field(
        default=None,
        description="A route by which this drug may be administered, e.g. 'oral'.",union_mode="smart"
    )
    
    prescribingInfo: Union[List[str], str] = Field(
        default=None,
        description="Link to prescribing information for the drug.",union_mode="smart"
    )
    
    warning: Union[List[str], str] = Field(
        default=None,
        description="Any FDA or other warnings about the drug (text or URL).",union_mode="smart"
    )
    ...
    nonProprietaryName: Union[List[str], str] = Field(
        default=None,
        description="The generic name of this drug or supplement.",union_mode="smart"
    )
    
    pregnancyCategory: Union[List[str], str] = Field(
        default=None,
        description="Pregnancy category of this drug.",union_mode="smart"
    )
    ...
    rxcui: Union[List[str], str] = Field(
        default=None,
        description="The RxCUI drug identifier from RXNORM.",union_mode="smart"
    )
    
    interactingDrug: Union[List[str], str] = Field(
        default=None,
     ...
     "as contraindications.",union_mode="smart"
    )
    
    drugClass: Union[List[str], str] = Field(
        default=None,
        description="The class of drug this belongs to (e.g., statins).",union_mode="smart"
    )
    
    dosageForm: Union[List[str], str] = Field(
        default=None,
        description="A dosage form in which this drug/supplement is available, e.g. 'tablet', 'suspension',"
     "'injection'.",union_mode="smart"
    )
    
    relatedDrug: Union[List[str], str] = Field(
        default=None,
        description="Any other drug related to this one, for example commonly-prescribed alternatives.",union_mode="smart"
    )
    
    availableStrength: Union[List[str], str] = Field(
        default=None,
        description="An available dosage strength for the drug.",union_mode="smart"
    )
    
    isAvailableGenerically: Union[List[str], str] = Field(
        default=None,
        description="True if the drug is available in a generic form (regardless of name).",union_mode="smart"
    )
    ...
    mechanismOfAction: Union[List[str], str] = Field(
        default=None,
        description="The specific biochemical interaction through which this drug or supplement produces"
     "its pharmacological effect.",union_mode="smart"
    )
    
    clincalPharmacology: Union[List[str], str] = Field(
        default=None,
        description="Description of the absorption and elimination of drugs, including their concentration"
     "(pharmacokinetics, pK) and biological effects (pharmacodynamics, pD).",union_mode="smart"
    )
    
    breastfeedingWarning: Union[List[str], str] = Field(
        default=None,
        description="Any precaution, guidance, contraindication, etc. related to this drug's use by breastfeeding"
     "mothers.",union_mode="smart"
    )
    
    labelDetails: Union[List[str], str] = Field(
        default=None,
        description="Link to the drug's label details.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import DoseSchedule, MaximumDoseSchedule, DrugPregnancyCategory, Boolean, DrugLegalStatus, DrugPrescriptionStatus, DrugClass, DrugStrength, Text, StrictBool, URL, MedicalEnumeration, Drug, HealthInsurancePlan, AnyUrl
    from pydantic_schemaorg import Text, MaximumDoseSchedule
