...
class RentalCarReservation(SchemaOrgBase):
    ...
    dropoffTime: Union[List[str], str] = Field(
        default=None,
        description="When a rental car can be dropped off.",union_mode="smart"
    )
    
    dropoffLocation: Union[List[str], str] = Field(
        default=None,
        description="Where a rental car can be dropped off.",union_mode="smart"
    )
    
    pickupLocation: Union[List[str], str] = Field(
        default=None,
        description="Where a taxi will pick up a passenger or a rental car can be picked up.",union_mode="smart"
    )
    
    pickupTime: Union[List[str], str] = Field(
        default=None,
        description="When a taxi will pick up a passenger or a rental car can be picked up.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Place, datetime, DateTime
