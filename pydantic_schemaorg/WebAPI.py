...
class WebAPI(SchemaOrgBase):
    ...
    documentation: Union[List[str], str] = Field(
        default=None,
        description="Further documentation describing the Web API in more detail.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import URL, CreativeWork, AnyUrl
