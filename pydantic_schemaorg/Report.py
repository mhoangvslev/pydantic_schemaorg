...
class Report(SchemaOrgBase):
    ...
    reportNumber: Union[List[str], str] = Field(
        default=None,
        description="The number or other unique designator assigned to a Report by the publishing organization.",union_mode="smart"
    )
