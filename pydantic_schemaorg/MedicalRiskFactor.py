...
class MedicalRiskFactor(SchemaOrgBase):
    ...
    increasesRiskOf: Union[List[str], str] = Field(
        default=None,
        description="The condition, complication, etc. influenced by this factor.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import MedicalEntity
