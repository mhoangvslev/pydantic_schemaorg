...
class EmployeeRole(SchemaOrgBase):
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, MonetaryAmount, PriceSpecification, Number, StrictInt, StrictFloat
