...
class EmailMessage(SchemaOrgBase):
    """An email message.
    ...
    dateSent: Union[List[str], str] = Field(
        default=None,
        description="The date/time at which the message was sent.",union_mode="smart"
    )
    
    dateReceived: Union[List[str], str] = Field(
        default=None,
        description="The date/time the message was received if a single recipient exists.",union_mode="smart"
    )
    
    ccRecipient: Union[List[str], str] = Field(
        default=None,
        description="A sub property of recipient. The recipient copied on a message.",union_mode="smart"
    )
    
    toRecipient: Union[List[str], str] = Field(
        default=None,
        description="A sub property of recipient. The recipient who was directly sent the message.",union_mode="smart"
    )
    
    sender: Union[List[str], str] = Field(
        default=None,
        description="A sub property of participant. The participant who is at the sending end of the action.",union_mode="smart"
    )
    
    messageAttachment: Union[List[str], str] = Field(
        default=None,
        description="A CreativeWork attached to the message.",union_mode="smart"
    )
    
    dateRead: Union[List[str], str] = Field(
        default=None,
        description="The date/time at which the message has been read by the recipient if a single recipient"
     "exists.",union_mode="smart"
    )
    
    bccRecipient: Union[List[str], str] = Field(
        default=None,
        description="A sub property of recipient. The recipient blind copied on a message.",union_mode="smart"
    )
    
    recipient: Union[List[str], str] = Field(
        default=None,
        description="A sub property of participant. The participant who is at the receiving end of the action.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import date, Organization, Audience, datetime, DateTime, Date, Person, CreativeWork, ContactPoint
