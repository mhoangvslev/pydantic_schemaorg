...
class Airport(SchemaOrgBase):
    ...
    iataCode: Union[List[str], str] = Field(
        default=None,
        description="IATA identifier for an airline or airport.",union_mode="smart"
    )
    
    icaoCode: Union[List[str], str] = Field(
        default=None,
        description="ICAO identifier for an airport.",union_mode="smart"
    )
