...
class MusicComposition(SchemaOrgBase):
    ...
    lyricist: Union[List[str], str] = Field(
        default=None,
        description="The person who wrote the words.",union_mode="smart"
    )
    
    recordedAs: Union[List[str], str] = Field(
        default=None,
        description="An audio recording of the work.",union_mode="smart"
    )
    
    musicalKey: Union[List[str], str] = Field(
        default=None,
        description="The key, mode, or scale this composition uses.",union_mode="smart"
    )
    
    firstPerformance: Union[List[str], str] = Field(
        default=None,
        description="The date and place the work was first performed.",union_mode="smart"
    )
    
    musicArrangement: Union[List[str], str] = Field(
        default=None,
        description="An arrangement derived from the composition.",union_mode="smart"
    )
    
    iswcCode: Union[List[str], str] = Field(
        default=None,
        description="The International Standard Musical Work Code for the composition.",union_mode="smart"
    )
    
    lyrics: Union[List[str], str] = Field(
        default=None,
        description="The words in the song.",union_mode="smart"
    )
    ...
    musicCompositionForm: Union[List[str], str] = Field(
        default=None,
        description="The type of composition (e.g. overture, sonata, symphony, etc.).",union_mode="smart"
    )
    
    includedComposition: Union[List[str], str] = Field(
        default=None,
        description="Smaller compositions included in this work (e.g. a movement in a symphony).",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import Text, Organization, Event, CreativeWork, MusicRecording, Person, MusicComposition
