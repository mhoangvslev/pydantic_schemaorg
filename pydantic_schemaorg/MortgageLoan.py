...
class MortgageLoan(SchemaOrgBase):
    ...
    domiciledMortgage: Union[List[str], str] = Field(
        default=None,
        description="Whether borrower is a resident of the jurisdiction where the property is located.",union_mode="smart"
    )
    
    loanMortgageMandateAmount: Union[List[str], str] = Field(
        default=None,
        description="Amount of mortgage mandate that can be converted into a proper mortgage at a later stage.",union_mode="smart"
    )
...
if TYPE_CHECKING:
    from pydantic_schemaorg import StrictBool, MonetaryAmount, Boolean
