...
import jinja2
from constants import data_type_map
from constants import PACKAGE_NAME
from jinja import jinja_env
from models import Import
from models import PydanticClass
from models import PydanticField
...
class SchemaOrg:
    def __init__(
        ...
        self.pydantic_classes: dict[str, PydanticClass | tuple] = dict()
    ...
    def update_imports(
        ...
        filter_func: Callable[[Import], bool] = (  # noqa: E731
    ...
    def _to_set(_object, prop="@id") -> set[str]:
        if isinstance(_object, list):
            return {item[prop] if prop is not None else item for item in _object}
